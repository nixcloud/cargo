...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "cargo-platform-0_2_0-9528fcbd58f1490b";
    meta.cargo_crate_info = {
      name = "cargo-platform";
      version = "0.2.0";
      crate_hash = "9528fcbd58f1490b";
      type = "";
    };
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=3c65ad3fd63fdc74 \
              -C extra-filename=-9528fcbd58f1490b \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern serde=${serde-1_0_218-ed8707ff8dc168e7}/libserde-ed8707ff8dc168e7.rmeta 2> $rustc_json_output_lines
      rustc_exit_value=$?
      set +x -e
