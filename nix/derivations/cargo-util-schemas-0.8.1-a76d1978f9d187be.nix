...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "cargo-util-schemas-0_8_1-a76d1978f9d187be";
    meta.cargo_crate_info = {
      name = "cargo-util-schemas";
      version = "0.8.1";
      crate_hash = "a76d1978f9d187be";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [semver-1_0_25-66c86f3f308501e7 serde-1_0_218-ed8707ff8dc168e7 serde-untagged-0_1_6-c26af987742396e6 serde-value-0_7_0-e37675eb779359e0 thiserror-2_0_11-c6c4ee382aacde15 toml-0_8_20-b9f11c4f8c54e863 unicode-xid-0_2_6-37bd325ac1f9ec54 url-2_5_4-659fce6bf9b29cb7];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=8ceeecf57527a201 \
              -C extra-filename=-a76d1978f9d187be \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              ...
              --extern serde_value=${serde-value-0_7_0-e37675eb779359e0}/libserde_value-e37675eb779359e0.rmeta \
              ...
              --extern unicode_xid=${unicode-xid-0_2_6-37bd325ac1f9ec54}/libunicode_xid-37bd325ac1f9ec54.rmeta \
