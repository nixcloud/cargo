...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m linux-raw-sys-0_4_15-624798d9199ea3b3"
      echo "@cargo { \"type\":0, \"crate_name\":\"linux-raw-sys\", \"id\":\"linux-raw-sys-0_4_15-624798d9199ea3b3\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "linux-raw-sys-0_4_15-624798d9199ea3b3" \
          --arg crate_name "linux-raw-sys" \
