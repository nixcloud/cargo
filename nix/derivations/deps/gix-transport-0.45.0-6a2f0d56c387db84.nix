...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-transport-0_45_0-6a2f0d56c387db84";
    meta.cargo_crate_info = {
      name = "gix-transport";
      version = "0.45.0";
      crate_hash = "6a2f0d56c387db84";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [base64-0_22_1-169e80cc244b88d1 bstr-1_11_3-14003bcd5b7b8103 curl-0_4_47-f684c2bd7b0f950d gix-command-0_4_1-e29484d4d4e346e8 gix-credentials-0_27_0-48aff77da2287bad gix-features-0_40_0-7b4fa941d491da9c gix-packetline-0_18_3-bfc74beed2d78867 gix-quote-0_4_15-8a0f189e1c6e7301 gix-sec-0_10_11-a898e4a50340a006 gix-url-0_29_0-74b20df333b8da83 thiserror-2_0_11-a57592ffa4ea41e0];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-transport-0_45_0-6a2f0d56c387db84"
      echo "@cargo { \"type\":0, \"crate_name\":\"gix-transport\", \"id\":\"gix-transport-0_45_0-6a2f0d56c387db84\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=c7d900eca3c0bb8d \
              -C extra-filename=-6a2f0d56c387db84 \
              --out-dir $OUT_DIR \
              ...
              --extern gix_packetline=${gix-packetline-0_18_3-bfc74beed2d78867}/libgix_packetline-bfc74beed2d78867.rmeta \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "gix-transport-0_45_0-6a2f0d56c387db84" \
          --arg crate_name "gix-transport" \
