...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "tracing-core-0_1_33-aece38920b28e8c6";
    meta.cargo_crate_info = {
      name = "tracing-core";
      version = "0.1.33";
      crate_hash = "aece38920b28e8c6";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [once_cell-1_20_3-65600a49c06310f1];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=84b51dce7e0bb852 \
              -C extra-filename=-aece38920b28e8c6 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
