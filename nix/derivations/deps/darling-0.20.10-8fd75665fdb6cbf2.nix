...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "darling-0_20_10-8fd75665fdb6cbf2";
    meta.cargo_crate_info = {
      name = "darling";
      version = "0.20.10";
      crate_hash = "8fd75665fdb6cbf2";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [darling_core-0_20_10-33b904f525621e82 darling_macro-0_20_10-af8d834bbc2463c3];
...
implementing custom derives.";
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=b11c6f9ed8c3b08f \
              -C extra-filename=-8fd75665fdb6cbf2 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern darling_core=${darling_core-0_20_10-33b904f525621e82}/libdarling_core-33b904f525621e82.rmeta \
              --extern darling_macro=${darling_macro-0_20_10-af8d834bbc2463c3}/libdarling_macro-af8d834bbc2463c3.so \
