...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m socket2-0_5_8-5c7e1d07a2b2a7e8"
      echo "@cargo { \"type\":0, \"crate_name\":\"socket2\", \"id\":\"socket2-0_5_8-5c7e1d07a2b2a7e8\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "socket2-0_5_8-5c7e1d07a2b2a7e8" \
          --arg crate_name "socket2" \
