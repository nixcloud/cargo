...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "serde-value-0_7_0-e37675eb779359e0";
    meta.cargo_crate_info = {
      name = "serde-value";
      version = "0.7.0";
      crate_hash = "e37675eb779359e0";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [ordered-float-2_10_1-9038a1abe48f7d3f serde-1_0_218-ed8707ff8dc168e7];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=fbe980b9eefa0174 \
              -C extra-filename=-e37675eb779359e0 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern ordered_float=${ordered-float-2_10_1-9038a1abe48f7d3f}/libordered_float-9038a1abe48f7d3f.rmeta \
