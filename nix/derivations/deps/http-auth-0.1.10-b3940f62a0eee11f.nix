...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m http-auth-0_1_10-b3940f62a0eee11f"
      echo "@cargo { \"type\":0, \"crate_name\":\"http-auth\", \"id\":\"http-auth-0_1_10-b3940f62a0eee11f\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "http-auth-0_1_10-b3940f62a0eee11f" \
          --arg crate_name "http-auth" \
