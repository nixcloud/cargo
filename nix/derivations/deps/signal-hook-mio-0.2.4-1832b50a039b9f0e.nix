...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "signal-hook-mio-0_2_4-1832b50a039b9f0e";
    meta.cargo_crate_info = {
      name = "signal-hook-mio";
      version = "0.2.4";
      crate_hash = "1832b50a039b9f0e";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [libc-0_2_175-b265bb513a0388f3 mio-0_8_11-4f2afca5af8b8fd0 signal-hook-0_3_18-e8d16b5f96fe21a7];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=bb03d960fd0fc0b6 \
              -C extra-filename=-1832b50a039b9f0e \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              ...
              --extern mio_0_8=${mio-0_8_11-4f2afca5af8b8fd0}/libmio-4f2afca5af8b8fd0.rmeta \
