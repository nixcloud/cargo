...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m shell-words-1_1_0-584d11ea81812f9b"
      echo "@cargo { \"type\":0, \"crate_name\":\"shell-words\", \"id\":\"shell-words-1_1_0-584d11ea81812f9b\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "shell-words-1_1_0-584d11ea81812f9b" \
          --arg crate_name "shell-words" \
