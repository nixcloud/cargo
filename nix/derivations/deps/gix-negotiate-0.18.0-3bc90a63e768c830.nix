...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-negotiate-0_18_0-3bc90a63e768c830";
    meta.cargo_crate_info = {
      name = "gix-negotiate";
      version = "0.18.0";
      crate_hash = "3bc90a63e768c830";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bitflags-2_8_0-d8308ebf07e22afd gix-commitgraph-0_26_0-f831d83001ac5121 gix-date-0_9_3-ef3873a712c7b7c9 gix-hash-0_16_0-2dd06b7faad8300b gix-object-0_47_0-1feb494be43bf821 gix-revwalk-0_18_0-58438d094712a949 smallvec-1_13_2-e5874423828ed52b thiserror-2_0_11-a57592ffa4ea41e0];
    passthru.rust_crate_parent = [];
    passthru.rust_script_build_run = [];
    phases = "unpackPhase buildPhase";

    src = pkgs.fetchurl {
      url = "https://crates.io/api/v1/crates/gix-negotiate/0.18.0/download";
      sha256 = "a6a8af1ef7bbe303d30b55312b7f4d33e955de43a3642ae9b7347c623d80ef80";
    };
    unpackPhase = ''
      tar xf $src
      cd gix-negotiate-0.18.0
    '';

    RUSTC = "${rustc}/bin/rustc";
    CARGO = "${cargo}/bin/cargo";

    CARGO_CRATE_NAME = "gix_negotiate";
    CARGO_MANIFEST_DIR = "./";
    CARGO_MANIFEST_PATH = "./Cargo.toml";
    CARGO_PKG_AUTHORS = "Sebastian Thiel <sebastian.thiel@icloud.com>";
    CARGO_PKG_DESCRIPTION = "A crate of the gitoxide project implementing negotiation algorithms";
    CARGO_PKG_HOMEPAGE = "";
    CARGO_PKG_LICENSE = "MIT OR Apache-2.0";
    CARGO_PKG_LICENSE_FILE = "";
    CARGO_PKG_NAME = "gix-negotiate";
    CARGO_PKG_README = "";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-negotiate-0_18_0-3bc90a63e768c830"
      echo "@cargo { \"type\":0, \"crate_name\":\"gix-negotiate\", \"id\":\"gix-negotiate-0_18_0-3bc90a63e768c830\" }"

      rustc_json_output_lines=$(${pkgs.mktemp}/bin/mktemp)
      set -x +e
      ${RUSTC} \
              --crate-name gix_negotiate \
              ...
              -C metadata=79f4ec4c3031d591 \
              -C extra-filename=-3bc90a63e768c830 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "gix-negotiate-0_18_0-3bc90a63e768c830" \
          --arg crate_name "gix-negotiate" \
