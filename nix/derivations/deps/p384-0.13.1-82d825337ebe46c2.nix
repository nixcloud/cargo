...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m p384-0_13_1-82d825337ebe46c2"
      echo "@cargo { \"type\":0, \"crate_name\":\"p384\", \"id\":\"p384-0_13_1-82d825337ebe46c2\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "p384-0_13_1-82d825337ebe46c2" \
          --arg crate_name "p384" \
