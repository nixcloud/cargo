...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "colorchoice-1_0_3-3fd8e2bb93f5239a";
    meta.cargo_crate_info = {
      name = "colorchoice";
      version = "1.0.3";
      crate_hash = "3fd8e2bb93f5239a";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m colorchoice-1_0_3-3fd8e2bb93f5239a"
      echo "@cargo { \"type\":0, \"crate_name\":\"colorchoice\", \"id\":\"colorchoice-1_0_3-3fd8e2bb93f5239a\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=d564478e8c49547f \
              -C extra-filename=-3fd8e2bb93f5239a \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "colorchoice-1_0_3-3fd8e2bb93f5239a" \
          --arg crate_name "colorchoice" \
