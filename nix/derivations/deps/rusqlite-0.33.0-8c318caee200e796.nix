...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "rusqlite-0_33_0-8c318caee200e796";
    meta.cargo_crate_info = {
      name = "rusqlite";
      version = "0.33.0";
      crate_hash = "8c318caee200e796";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [bitflags-2_8_0-25bacb8b683e4264 fallible-iterator-0_3_0-2c14c8adfb18ad4f fallible-streaming-iterator-0_1_9-1108f90d36611767 hashlink-0_10_0-0e6ad142faf8aa5f libsqlite3-sys-0_31_0-16ed399da4d69400 smallvec-1_13_2-0ef9b24879be6fdc];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=6447ad47bc3f2423 \
              -C extra-filename=-8c318caee200e796 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              ...
              --extern fallible_iterator=${fallible-iterator-0_3_0-2c14c8adfb18ad4f}/libfallible_iterator-2c14c8adfb18ad4f.rmeta \
              --extern fallible_streaming_iterator=${fallible-streaming-iterator-0_1_9-1108f90d36611767}/libfallible_streaming_iterator-1108f90d36611767.rmeta \
              --extern hashlink=${hashlink-0_10_0-0e6ad142faf8aa5f}/libhashlink-0e6ad142faf8aa5f.rmeta \
              --extern libsqlite3_sys=${libsqlite3-sys-0_31_0-16ed399da4d69400}/liblibsqlite3_sys-16ed399da4d69400.rmeta \
