...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "time-0_3_37-470f9c4ebcfb97a1";
    meta.cargo_crate_info = {
      name = "time";
      version = "0.3.37";
      crate_hash = "470f9c4ebcfb97a1";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [deranged-0_3_11-091ab43039ab41fd itoa-1_0_14-f807d60e93b08a94 num-conv-0_1_0-ad9feb8f6a55300b powerfmt-0_2_0-85c859974cceb22a serde-1_0_218-ed8707ff8dc168e7 time-core-0_1_2-7f4ef3fe093734ac];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=fbc6f3e87e58d583 \
              -C extra-filename=-470f9c4ebcfb97a1 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern deranged=${deranged-0_3_11-091ab43039ab41fd}/libderanged-091ab43039ab41fd.rmeta \
              --extern itoa=${itoa-1_0_14-f807d60e93b08a94}/libitoa-f807d60e93b08a94.rmeta \
              --extern num_conv=${num-conv-0_1_0-ad9feb8f6a55300b}/libnum_conv-ad9feb8f6a55300b.rmeta \
              --extern powerfmt=${powerfmt-0_2_0-85c859974cceb22a}/libpowerfmt-85c859974cceb22a.rmeta \
              --extern serde=${serde-1_0_218-ed8707ff8dc168e7}/libserde-ed8707ff8dc168e7.rmeta \
              --extern time_core=${time-core-0_1_2-7f4ef3fe093734ac}/libtime_core-7f4ef3fe093734ac.rmeta \
