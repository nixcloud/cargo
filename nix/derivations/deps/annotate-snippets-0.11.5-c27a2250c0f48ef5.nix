...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "annotate-snippets-0_11_5-c27a2250c0f48ef5";
    meta.cargo_crate_info = {
      name = "annotate-snippets";
      version = "0.11.5";
      crate_hash = "c27a2250c0f48ef5";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [anstyle-1_0_10-051477b24e08c8d1 unicode-width-0_2_0-76d8e9c15baf673e];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=453ab31f4dfedf69 \
              -C extra-filename=-c27a2250c0f48ef5 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
