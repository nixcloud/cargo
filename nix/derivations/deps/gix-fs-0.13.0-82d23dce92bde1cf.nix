...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-fs-0_13_0-82d23dce92bde1cf";
    meta.cargo_crate_info = {
      name = "gix-fs";
      version = "0.13.0";
      crate_hash = "82d23dce92bde1cf";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [fastrand-2_3_0-a6e21b8cf3724d00 gix-features-0_40_0-786b5f2993cbc7d3 gix-utils-0_1_14-1374b61d28fc65a7];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=0723f5343bc599cd \
              -C extra-filename=-82d23dce92bde1cf \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
