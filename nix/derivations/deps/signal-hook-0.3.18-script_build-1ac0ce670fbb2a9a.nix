...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "signal-hook-0_3_18-script_build-1ac0ce670fbb2a9a";
    meta.cargo_crate_info = {
      name = "signal-hook";
      version = "0.3.18";
      crate_hash = "1ac0ce670fbb2a9a";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m signal-hook-0_3_18-script_build-1ac0ce670fbb2a9a"
      echo "@cargo { \"type\":0, \"crate_name\":\"signal-hook\", \"id\":\"signal-hook-0_3_18-script_build-1ac0ce670fbb2a9a\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=97c3941d1b5452e9 \
              -C extra-filename=-1ac0ce670fbb2a9a \
              --out-dir $OUT_DIR \
      ...
      do
          ...
          ${pkgs.jq}/bin/jq -r -c 'select(."$message_type"=="diagnostic") | .rendered' $tmpFile
            ...
            ln -s $OUT_DIR/"$CARGO_CRATE_NAME"-1ac0ce670fbb2a9a $OUT_DIR/build_script_build
      
      # return structured formatted errors for later processing
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "signal-hook-0_3_18-script_build-1ac0ce670fbb2a9a" \
