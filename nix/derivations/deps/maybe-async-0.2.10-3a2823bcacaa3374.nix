...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m maybe-async-0_2_10-3a2823bcacaa3374"
      echo "@cargo { \"type\":0, \"crate_name\":\"maybe-async\", \"id\":\"maybe-async-0_2_10-3a2823bcacaa3374\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "maybe-async-0_2_10-3a2823bcacaa3374" \
          --arg crate_name "maybe-async" \
