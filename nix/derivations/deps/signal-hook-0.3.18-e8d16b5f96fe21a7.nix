...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "signal-hook-0_3_18-e8d16b5f96fe21a7";
    meta.cargo_crate_info = {
      name = "signal-hook";
      version = "0.3.18";
      crate_hash = "e8d16b5f96fe21a7";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [libc-0_2_175-b265bb513a0388f3 signal-hook-registry-1_4_6-8d59c67727f45690];
    passthru.rust_crate_parent = [signal-hook-0_3_18-script_build_run-ef232cac941a5dce];
    passthru.rust_script_build_run = [signal-hook-0_3_18-script_build_run-ef232cac941a5dce];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=4d92c3ea3152b68e \
              -C extra-filename=-e8d16b5f96fe21a7 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              ...
              --extern signal_hook_registry=${signal-hook-registry-1_4_6-8d59c67727f45690}/libsignal_hook_registry-8d59c67727f45690.rmeta \
