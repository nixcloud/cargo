...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m memchr-2_7_4-3cee6db17bbe0dde"
      echo "@cargo { \"type\":0, \"crate_name\":\"memchr\", \"id\":\"memchr-2_7_4-3cee6db17bbe0dde\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "memchr-2_7_4-3cee6db17bbe0dde" \
          --arg crate_name "memchr" \
