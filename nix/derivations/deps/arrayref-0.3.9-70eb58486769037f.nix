...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "arrayref-0_3_9-70eb58486769037f";
    meta.cargo_crate_info = {
      name = "arrayref";
      version = "0.3.9";
      crate_hash = "70eb58486769037f";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m arrayref-0_3_9-70eb58486769037f"
      echo "@cargo { \"type\":0, \"crate_name\":\"arrayref\", \"id\":\"arrayref-0_3_9-70eb58486769037f\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=3bb647570fe7136e \
              -C extra-filename=-70eb58486769037f \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "arrayref-0_3_9-70eb58486769037f" \
          --arg crate_name "arrayref" \
