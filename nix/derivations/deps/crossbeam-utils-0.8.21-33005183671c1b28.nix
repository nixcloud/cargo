...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "crossbeam-utils-0_8_21-33005183671c1b28";
    meta.cargo_crate_info = {
      name = "crossbeam-utils";
      version = "0.8.21";
      crate_hash = "33005183671c1b28";
      type = "";
    };
    ...
    passthru.rust_crate_parent = [crossbeam-utils-0_8_21-script_build_run-fdbe690e32d2fd05];
    passthru.rust_script_build_run = [crossbeam-utils-0_8_21-script_build_run-fdbe690e32d2fd05];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=0e3edbdcbcb1a4b7 \
              -C extra-filename=-33005183671c1b28 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
