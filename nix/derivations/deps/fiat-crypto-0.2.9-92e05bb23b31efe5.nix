...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "fiat-crypto-0_2_9-92e05bb23b31efe5";
    meta.cargo_crate_info = {
      name = "fiat-crypto";
      version = "0.2.9";
      crate_hash = "92e05bb23b31efe5";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m fiat-crypto-0_2_9-92e05bb23b31efe5"
      echo "@cargo { \"type\":0, \"crate_name\":\"fiat-crypto\", \"id\":\"fiat-crypto-0_2_9-92e05bb23b31efe5\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=9fd95c2dd78c448b \
              -C extra-filename=-92e05bb23b31efe5 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "fiat-crypto-0_2_9-92e05bb23b31efe5" \
          --arg crate_name "fiat-crypto" \
