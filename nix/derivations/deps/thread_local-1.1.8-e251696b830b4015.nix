...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "thread_local-1_1_8-e251696b830b4015";
    meta.cargo_crate_info = {
      name = "thread_local";
      version = "1.1.8";
      crate_hash = "e251696b830b4015";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [cfg-if-1_0_0-616d46354eebf850 once_cell-1_20_3-60992a3834e62ae0];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m thread_local-1_1_8-e251696b830b4015"
      echo "@cargo { \"type\":0, \"crate_name\":\"thread_local\", \"id\":\"thread_local-1_1_8-e251696b830b4015\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=f964f3fd02bb983b \
              -C extra-filename=-e251696b830b4015 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "thread_local-1_1_8-e251696b830b4015" \
          --arg crate_name "thread_local" \
