...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "crossbeam-channel-0_5_14-302e921e2a8d4ce6";
    meta.cargo_crate_info = {
      name = "crossbeam-channel";
      version = "0.5.14";
      crate_hash = "302e921e2a8d4ce6";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m crossbeam-channel-0_5_14-302e921e2a8d4ce6"
      echo "@cargo { \"type\":0, \"crate_name\":\"crossbeam-channel\", \"id\":\"crossbeam-channel-0_5_14-302e921e2a8d4ce6\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=273b9dc6128e7f3d \
              -C extra-filename=-302e921e2a8d4ce6 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "crossbeam-channel-0_5_14-302e921e2a8d4ce6" \
          --arg crate_name "crossbeam-channel" \
