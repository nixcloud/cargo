...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m ahash-0_8_11-script_build-dfb7cac56dd48573"
      echo "@cargo { \"type\":0, \"crate_name\":\"ahash\", \"id\":\"ahash-0_8_11-script_build-dfb7cac56dd48573\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "ahash-0_8_11-script_build-dfb7cac56dd48573" \
