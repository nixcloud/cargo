...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-submodule-0_17_0-3e55b4fc27cc42ec";
    meta.cargo_crate_info = {
      name = "gix-submodule";
      version = "0.17.0";
      crate_hash = "3e55b4fc27cc42ec";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bstr-1_11_3-14003bcd5b7b8103 gix-config-0_43_0-c2a2493ddeeda786 gix-path-0_10_14-6bb928c9998da5a8 gix-pathspec-0_9_0-8c1afc1e63b302a6 gix-refspec-0_28_0-e29e1a847ad4941f gix-url-0_29_0-74b20df333b8da83 thiserror-2_0_11-a57592ffa4ea41e0];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-submodule-0_17_0-3e55b4fc27cc42ec"
      echo "@cargo { \"type\":0, \"crate_name\":\"gix-submodule\", \"id\":\"gix-submodule-0_17_0-3e55b4fc27cc42ec\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=794830f1a1ec1278 \
              -C extra-filename=-3e55b4fc27cc42ec \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "gix-submodule-0_17_0-3e55b4fc27cc42ec" \
          --arg crate_name "gix-submodule" \
