...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-discover-0_38_0-243df1ed30f8cacf";
    meta.cargo_crate_info = {
      name = "gix-discover";
      version = "0.38.0";
      crate_hash = "243df1ed30f8cacf";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [bstr-1_11_3-46100c463ffaaa37 gix-fs-0_13_0-82d23dce92bde1cf gix-hash-0_16_0-d473f2b9165b7ac8 gix-path-0_10_14-fac4f7c597a0c8bd gix-ref-0_50_0-118027e5bbad2abb gix-sec-0_10_11-c1812e93e0aabb9f thiserror-2_0_11-c6c4ee382aacde15];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=a90851f6e395ee82 \
              -C extra-filename=-243df1ed30f8cacf \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
