...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "hashbrown-0_15_2-6ee06c8f0a23f90a";
    meta.cargo_crate_info = {
      name = "hashbrown";
      version = "0.15.2";
      crate_hash = "6ee06c8f0a23f90a";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [foldhash-0_1_4-d4aabb52aef12cd1];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m hashbrown-0_15_2-6ee06c8f0a23f90a"
      echo "@cargo { \"type\":0, \"crate_name\":\"hashbrown\", \"id\":\"hashbrown-0_15_2-6ee06c8f0a23f90a\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=c183fedc6c607531 \
              -C extra-filename=-6ee06c8f0a23f90a \
              --out-dir $OUT_DIR \
              ${fn.rustc_linker_arguments passthru.rust_crate_libraries} \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              --extern foldhash=${foldhash-0_1_4-d4aabb52aef12cd1}/libfoldhash-d4aabb52aef12cd1.rmeta \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "hashbrown-0_15_2-6ee06c8f0a23f90a" \
