...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-revwalk-0_18_0-58438d094712a949";
    meta.cargo_crate_info = {
      name = "gix-revwalk";
      version = "0.18.0";
      crate_hash = "58438d094712a949";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [gix-commitgraph-0_26_0-f831d83001ac5121 gix-date-0_9_3-ef3873a712c7b7c9 gix-hash-0_16_0-2dd06b7faad8300b gix-hashtable-0_7_0-cf7f65c45ebb5acb gix-object-0_47_0-1feb494be43bf821 smallvec-1_13_2-e5874423828ed52b thiserror-2_0_11-a57592ffa4ea41e0];
    passthru.rust_crate_parent = [];
    passthru.rust_script_build_run = [];
    phases = "unpackPhase buildPhase";

    src = pkgs.fetchurl {
      url = "https://crates.io/api/v1/crates/gix-revwalk/0.18.0/download";
      sha256 = "d4ecb80c235b1e9ef2b99b23a81ea50dd569a88a9eb767179793269e0e616247";
    };
    unpackPhase = ''
      tar xf $src
      cd gix-revwalk-0.18.0
    '';

    RUSTC = "${rustc}/bin/rustc";
    CARGO = "${cargo}/bin/cargo";

    CARGO_CRATE_NAME = "gix_revwalk";
    CARGO_MANIFEST_DIR = "./";
    CARGO_MANIFEST_PATH = "./Cargo.toml";
    CARGO_PKG_AUTHORS = "Sebastian Thiel <sebastian.thiel@icloud.com>";
    CARGO_PKG_DESCRIPTION = "A crate providing utilities for walking the revision graph";
    CARGO_PKG_HOMEPAGE = "";
    CARGO_PKG_LICENSE = "MIT OR Apache-2.0";
    CARGO_PKG_LICENSE_FILE = "";
    CARGO_PKG_NAME = "gix-revwalk";
    CARGO_PKG_README = "";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-revwalk-0_18_0-58438d094712a949"
      echo "@cargo { \"type\":0, \"crate_name\":\"gix-revwalk\", \"id\":\"gix-revwalk-0_18_0-58438d094712a949\" }"

      rustc_json_output_lines=$(${pkgs.mktemp}/bin/mktemp)
      set -x +e
      ${RUSTC} \
              --crate-name gix_revwalk \
              ...
              -C metadata=e02734e7debd6e11 \
              -C extra-filename=-58438d094712a949 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "gix-revwalk-0_18_0-58438d094712a949" \
          --arg crate_name "gix-revwalk" \
