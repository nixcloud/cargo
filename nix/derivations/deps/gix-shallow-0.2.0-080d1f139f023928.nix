...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-shallow-0_2_0-080d1f139f023928";
    meta.cargo_crate_info = {
      name = "gix-shallow";
      version = "0.2.0";
      crate_hash = "080d1f139f023928";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [bstr-1_11_3-46100c463ffaaa37 gix-hash-0_16_0-d473f2b9165b7ac8 gix-lock-16_0_0-8d2d91e093879452 thiserror-2_0_11-c6c4ee382aacde15];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=3c229301ca47c43b \
              -C extra-filename=-080d1f139f023928 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
