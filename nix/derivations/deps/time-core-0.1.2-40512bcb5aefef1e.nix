...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "time-core-0_1_2-40512bcb5aefef1e";
    meta.cargo_crate_info = {
      name = "time-core";
      version = "0.1.2";
      crate_hash = "40512bcb5aefef1e";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m time-core-0_1_2-40512bcb5aefef1e"
      echo "@cargo { \"type\":0, \"crate_name\":\"time-core\", \"id\":\"time-core-0_1_2-40512bcb5aefef1e\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=d524f6dd980e46bf \
              -C extra-filename=-40512bcb5aefef1e \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "time-core-0_1_2-40512bcb5aefef1e" \
          --arg crate_name "time-core" \
