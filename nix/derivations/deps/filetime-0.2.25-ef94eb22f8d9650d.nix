...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "filetime-0_2_25-ef94eb22f8d9650d";
    meta.cargo_crate_info = {
      name = "filetime";
      version = "0.2.25";
      crate_hash = "ef94eb22f8d9650d";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [cfg-if-1_0_0-39db481b14499192 libc-0_2_175-c1de36c6b4119d87];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=cb53d15002a9f0db \
              -C extra-filename=-ef94eb22f8d9650d \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
