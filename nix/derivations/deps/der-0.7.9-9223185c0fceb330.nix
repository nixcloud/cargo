...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "der-0_7_9-9223185c0fceb330";
    meta.cargo_crate_info = {
      name = "der";
      version = "0.7.9";
      crate_hash = "9223185c0fceb330";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [const-oid-0_9_6-ad382a9997690729 pem-rfc7468-0_7_0-a2854727203f56cc zeroize-1_8_1-966e26bee9773779];
...
full support for heapless no_std targets";
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=c1fa92f7b593a95f \
              -C extra-filename=-9223185c0fceb330 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
