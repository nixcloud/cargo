...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "supports-hyperlinks-3_1_0-d01c256720ea7038";
    meta.cargo_crate_info = {
      name = "supports-hyperlinks";
      version = "3.1.0";
      crate_hash = "d01c256720ea7038";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m supports-hyperlinks-3_1_0-d01c256720ea7038"
      echo "@cargo { \"type\":0, \"crate_name\":\"supports-hyperlinks\", \"id\":\"supports-hyperlinks-3_1_0-d01c256720ea7038\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=31690fee06d549c0 \
              -C extra-filename=-d01c256720ea7038 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "supports-hyperlinks-3_1_0-d01c256720ea7038" \
          --arg crate_name "supports-hyperlinks" \
