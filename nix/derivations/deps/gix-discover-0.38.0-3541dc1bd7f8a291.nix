...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-discover-0_38_0-3541dc1bd7f8a291";
    meta.cargo_crate_info = {
      name = "gix-discover";
      version = "0.38.0";
      crate_hash = "3541dc1bd7f8a291";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bstr-1_11_3-14003bcd5b7b8103 gix-fs-0_13_0-32f209ecf862a862 gix-hash-0_16_0-2dd06b7faad8300b gix-path-0_10_14-6bb928c9998da5a8 gix-ref-0_50_0-9c43a6c2d25dc4c1 gix-sec-0_10_11-a898e4a50340a006 thiserror-2_0_11-a57592ffa4ea41e0];
    passthru.rust_crate_parent = [];
    passthru.rust_script_build_run = [];
    phases = "unpackPhase buildPhase";

    src = pkgs.fetchurl {
      url = "https://crates.io/api/v1/crates/gix-discover/0.38.0/download";
      sha256 = "d0c2414bdf04064e0f5a5aa029dfda1e663cf9a6c4bfc8759f2d369299bb65d8";
    };
    unpackPhase = ''
      tar xf $src
      cd gix-discover-0.38.0
    '';

    RUSTC = "${rustc}/bin/rustc";
    CARGO = "${cargo}/bin/cargo";

    CARGO_CRATE_NAME = "gix_discover";
    CARGO_MANIFEST_DIR = "./";
    CARGO_MANIFEST_PATH = "./Cargo.toml";
    CARGO_PKG_AUTHORS = "Sebastian Thiel <sebastian.thiel@icloud.com>";
    CARGO_PKG_DESCRIPTION = "Discover git repositories and check if a directory is a git repository";
    CARGO_PKG_HOMEPAGE = "";
    CARGO_PKG_LICENSE = "MIT OR Apache-2.0";
    CARGO_PKG_LICENSE_FILE = "";
    CARGO_PKG_NAME = "gix-discover";
    CARGO_PKG_README = "";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-discover-0_38_0-3541dc1bd7f8a291"
      echo "@cargo { \"type\":0, \"crate_name\":\"gix-discover\", \"id\":\"gix-discover-0_38_0-3541dc1bd7f8a291\" }"

      rustc_json_output_lines=$(${pkgs.mktemp}/bin/mktemp)
      set -x +e
      ${RUSTC} \
              --crate-name gix_discover \
              ...
              -C metadata=53c431ed0ea2f1e2 \
              -C extra-filename=-3541dc1bd7f8a291 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "gix-discover-0_38_0-3541dc1bd7f8a291" \
          --arg crate_name "gix-discover" \
