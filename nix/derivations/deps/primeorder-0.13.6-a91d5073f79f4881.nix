...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "primeorder-0_13_6-a91d5073f79f4881";
    meta.cargo_crate_info = {
      name = "primeorder";
      version = "0.13.6";
      crate_hash = "a91d5073f79f4881";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [elliptic-curve-0_13_8-c56a877db253e598];
...
equation coefficients";
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=ff9916c8e6a909e7 \
              -C extra-filename=-a91d5073f79f4881 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
