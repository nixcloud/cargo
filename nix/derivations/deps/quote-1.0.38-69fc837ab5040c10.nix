...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "quote-1_0_38-69fc837ab5040c10";
    meta.cargo_crate_info = {
      name = "quote";
      version = "1.0.38";
      crate_hash = "69fc837ab5040c10";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [proc-macro2-1_0_93-8972bce74b99a2b8];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=e7db3e6adf5a1b2f \
              -C extra-filename=-69fc837ab5040c10 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
