...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "jiff-0_2_3-16345f2ab32d9b14";
    meta.cargo_crate_info = {
      name = "jiff";
      version = "0.2.3";
      crate_hash = "16345f2ab32d9b14";
    };
...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m jiff-0_2_3-16345f2ab32d9b14"
      echo "@cargo { \"type\":0, \"crate_name\":\"jiff\", \"id\":\"jiff-0_2_3-16345f2ab32d9b14\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=a93be2d7007071ac \
              -C extra-filename=-16345f2ab32d9b14 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "jiff-0_2_3-16345f2ab32d9b14" \
          --arg crate_name "jiff" \
