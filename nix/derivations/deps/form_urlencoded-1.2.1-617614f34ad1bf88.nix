...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "form_urlencoded-1_2_1-617614f34ad1bf88";
    meta.cargo_crate_info = {
      name = "form_urlencoded";
      version = "1.2.1";
      crate_hash = "617614f34ad1bf88";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [percent-encoding-2_3_1-87897a77b555a548];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=151b2e27b576f634 \
              -C extra-filename=-617614f34ad1bf88 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
