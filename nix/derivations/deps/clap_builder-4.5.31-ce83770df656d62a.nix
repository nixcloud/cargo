...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "clap_builder-4_5_31-ce83770df656d62a";
    meta.cargo_crate_info = {
      name = "clap_builder";
      version = "4.5.31";
      crate_hash = "ce83770df656d62a";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [anstream-0_6_18-59aa35a61b4ca0e8 anstyle-1_0_10-051477b24e08c8d1 clap_lex-0_7_4-ee15bee4b3047b45 strsim-0_11_1-ffcb0b37b460fa77 terminal_size-0_4_1-3f8cbf1619d40d95];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=9033fe6771275b9a \
              -C extra-filename=-ce83770df656d62a \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              ...
              --extern clap_lex=${clap_lex-0_7_4-ee15bee4b3047b45}/libclap_lex-ee15bee4b3047b45.rmeta \
              --extern strsim=${strsim-0_11_1-ffcb0b37b460fa77}/libstrsim-ffcb0b37b460fa77.rmeta \
              --extern terminal_size=${terminal_size-0_4_1-3f8cbf1619d40d95}/libterminal_size-3f8cbf1619d40d95.rmeta \
