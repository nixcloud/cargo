...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "libssh2-sys-0_3_1-6cd042864dac375d";
    meta.cargo_crate_info = {
      name = "libssh2-sys";
      version = "0.3.1";
      crate_hash = "6cd042864dac375d";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [libc-0_2_175-b265bb513a0388f3 libz-sys-1_1_21-8eb7d635fee6f8cb openssl-sys-0_9_106-fe430717cd107543];
    passthru.rust_crate_parent = [libssh2-sys-0_3_1-script_build_run-da060cf47d1b21a6];
    passthru.rust_script_build_run = [libssh2-sys-0_3_1-script_build_run-da060cf47d1b21a6];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=e699c2c4f6adc8c1 \
              -C extra-filename=-6cd042864dac375d \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
