...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "winnow-0_7_1-a5873bca62debc35";
    meta.cargo_crate_info = {
      name = "winnow";
      version = "0.7.1";
      crate_hash = "a5873bca62debc35";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m winnow-0_7_1-a5873bca62debc35"
      echo "@cargo { \"type\":0, \"crate_name\":\"winnow\", \"id\":\"winnow-0_7_1-a5873bca62debc35\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=335823a299f12a9c \
              -C extra-filename=-a5873bca62debc35 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "winnow-0_7_1-a5873bca62debc35" \
