...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m fnv-1_0_7-e86d9923dc926ea6"
      echo "@cargo { \"type\":0, \"crate_name\":\"fnv\", \"id\":\"fnv-1_0_7-e86d9923dc926ea6\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "fnv-1_0_7-e86d9923dc926ea6" \
          --arg crate_name "fnv" \
