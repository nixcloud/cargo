...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "stable_deref_trait-1_2_0-62798fe62205e471";
    meta.cargo_crate_info = {
      name = "stable_deref_trait";
      version = "1.2.0";
      crate_hash = "62798fe62205e471";
    };
...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m stable_deref_trait-1_2_0-62798fe62205e471"
      echo "@cargo { \"type\":0, \"crate_name\":\"stable_deref_trait\", \"id\":\"stable_deref_trait-1_2_0-62798fe62205e471\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=6793511ed0395dde \
              -C extra-filename=-62798fe62205e471 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "stable_deref_trait-1_2_0-62798fe62205e471" \
          --arg crate_name "stable_deref_trait" \
