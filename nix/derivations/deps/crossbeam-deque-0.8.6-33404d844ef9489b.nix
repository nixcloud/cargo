...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m crossbeam-deque-0_8_6-33404d844ef9489b"
      echo "@cargo { \"type\":0, \"crate_name\":\"crossbeam-deque\", \"id\":\"crossbeam-deque-0_8_6-33404d844ef9489b\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "crossbeam-deque-0_8_6-33404d844ef9489b" \
          --arg crate_name "crossbeam-deque" \
