...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m itertools-0_14_0-27edccb8d0332424"
      echo "@cargo { \"type\":0, \"crate_name\":\"itertools\", \"id\":\"itertools-0_14_0-27edccb8d0332424\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "itertools-0_14_0-27edccb8d0332424" \
          --arg crate_name "itertools" \
