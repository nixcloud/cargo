...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "color-print-proc-macro-0_3_7-92102f3133fdb913";
    meta.cargo_crate_info = {
      name = "color-print-proc-macro";
      version = "0.3.7";
      crate_hash = "92102f3133fdb913";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [nom-7_1_3-b6ce546ffc2ca11c proc-macro2-1_0_93-8972bce74b99a2b8 quote-1_0_38-69fc837ab5040c10 syn-2_0_98-cf14ab7ccae9dbe8];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=a1b3ea048b831667 \
              -C extra-filename=-92102f3133fdb913 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern nom=${nom-7_1_3-b6ce546ffc2ca11c}/libnom-b6ce546ffc2ca11c.rlib \
