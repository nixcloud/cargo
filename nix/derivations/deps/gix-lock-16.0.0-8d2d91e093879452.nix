...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-lock-16_0_0-8d2d91e093879452";
    meta.cargo_crate_info = {
      name = "gix-lock";
      version = "16.0.0";
      crate_hash = "8d2d91e093879452";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [gix-tempfile-16_0_0-741f0a837b503fa9 gix-utils-0_1_14-1374b61d28fc65a7 thiserror-2_0_11-c6c4ee382aacde15];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=ba6164799a35ede5 \
              -C extra-filename=-8d2d91e093879452 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
