...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m pest_generator-2_7_15-c669ba2a5e7aeb38"
      echo "@cargo { \"type\":0, \"crate_name\":\"pest_generator\", \"id\":\"pest_generator-2_7_15-c669ba2a5e7aeb38\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "pest_generator-2_7_15-c669ba2a5e7aeb38" \
          --arg crate_name "pest_generator" \
