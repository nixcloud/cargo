...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "libz-sys-1_1_21-8eb7d635fee6f8cb";
    meta.cargo_crate_info = {
      name = "libz-sys";
      version = "1.1.21";
      crate_hash = "8eb7d635fee6f8cb";
      type = "";
    };
    ...
    passthru.rust_crate_parent = [libz-sys-1_1_21-script_build_run-761a456dbed333b2];
    passthru.rust_script_build_run = [libz-sys-1_1_21-script_build_run-761a456dbed333b2];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=16be7a6d9f581746 \
              -C extra-filename=-8eb7d635fee6f8cb \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
