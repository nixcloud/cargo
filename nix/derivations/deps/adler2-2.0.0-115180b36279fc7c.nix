...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m adler2-2_0_0-115180b36279fc7c"
      echo "@cargo { \"type\":0, \"crate_name\":\"adler2\", \"id\":\"adler2-2_0_0-115180b36279fc7c\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "adler2-2_0_0-115180b36279fc7c" \
          --arg crate_name "adler2" \
