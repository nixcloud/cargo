...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "toml-0_8_20-7a483d12a9e19406";
    meta.cargo_crate_info = {
      name = "toml";
      version = "0.8.20";
      crate_hash = "7a483d12a9e19406";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [serde-1_0_218-472e28b9f131b02c serde_spanned-0_6_8-b8b72c3377341dbf toml_datetime-0_6_8-c22a379486cde223 toml_edit-0_22_24-24142c1671b8cfdf];
...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m toml-0_8_20-7a483d12a9e19406"
      echo "@cargo { \"type\":0, \"crate_name\":\"toml\", \"id\":\"toml-0_8_20-7a483d12a9e19406\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=e6e4b1764cca82af \
              -C extra-filename=-7a483d12a9e19406 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "toml-0_8_20-7a483d12a9e19406" \
          --arg crate_name "toml" \
