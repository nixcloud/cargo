...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "aho-corasick-1_1_3-511789a4780abe8b";
    meta.cargo_crate_info = {
      name = "aho-corasick";
      version = "1.1.3";
      crate_hash = "511789a4780abe8b";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [memchr-2_7_4-a0e5828b48f06e07];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=b29edd6ba17af0a8 \
              -C extra-filename=-511789a4780abe8b \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
