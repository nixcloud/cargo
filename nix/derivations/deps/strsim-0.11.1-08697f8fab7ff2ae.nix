...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m strsim-0_11_1-08697f8fab7ff2ae"
      echo "@cargo { \"type\":0, \"crate_name\":\"strsim\", \"id\":\"strsim-0_11_1-08697f8fab7ff2ae\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "strsim-0_11_1-08697f8fab7ff2ae" \
          --arg crate_name "strsim" \
