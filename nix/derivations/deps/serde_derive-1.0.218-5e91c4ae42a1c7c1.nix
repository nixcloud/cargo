...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "serde_derive-1_0_218-5e91c4ae42a1c7c1";
    meta.cargo_crate_info = {
      name = "serde_derive";
      version = "1.0.218";
      crate_hash = "5e91c4ae42a1c7c1";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m serde_derive-1_0_218-5e91c4ae42a1c7c1"
      echo "@cargo { \"type\":0, \"crate_name\":\"serde_derive\", \"id\":\"serde_derive-1_0_218-5e91c4ae42a1c7c1\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=4a6e0941bb63d46c \
              -C extra-filename=-5e91c4ae42a1c7c1 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "serde_derive-1_0_218-5e91c4ae42a1c7c1" \
          --arg crate_name "serde_derive" \
