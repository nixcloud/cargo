...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-attributes-0_24_0-64ee21b308ccf8d6";
    meta.cargo_crate_info = {
      name = "gix-attributes";
      version = "0.24.0";
      crate_hash = "64ee21b308ccf8d6";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [bstr-1_11_3-46100c463ffaaa37 gix-glob-0_18_0-cfb0a22bd88ebc1a gix-path-0_10_14-fac4f7c597a0c8bd gix-quote-0_4_15-761e55887e5c1d17 gix-trace-0_1_12-718f68523d5ac749 kstring-2_0_2-a79178d67703af0a smallvec-1_13_2-0ef9b24879be6fdc thiserror-2_0_11-c6c4ee382aacde15 unicode-bom-2_0_3-0618da7d75fc7211];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=d7a80b92c92befbe \
              -C extra-filename=-64ee21b308ccf8d6 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              ...
              --extern kstring=${kstring-2_0_2-a79178d67703af0a}/libkstring-a79178d67703af0a.rmeta \
              ...
              --extern unicode_bom=${unicode-bom-2_0_3-0618da7d75fc7211}/libunicode_bom-0618da7d75fc7211.rmeta \
