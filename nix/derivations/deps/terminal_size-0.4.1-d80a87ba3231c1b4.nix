...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m terminal_size-0_4_1-d80a87ba3231c1b4"
      echo "@cargo { \"type\":0, \"crate_name\":\"terminal_size\", \"id\":\"terminal_size-0_4_1-d80a87ba3231c1b4\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "terminal_size-0_4_1-d80a87ba3231c1b4" \
          --arg crate_name "terminal_size" \
