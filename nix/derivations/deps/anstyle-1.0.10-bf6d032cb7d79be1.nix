...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "anstyle-1_0_10-bf6d032cb7d79be1";
    meta.cargo_crate_info = {
      name = "anstyle";
      version = "1.0.10";
      crate_hash = "bf6d032cb7d79be1";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m anstyle-1_0_10-bf6d032cb7d79be1"
      echo "@cargo { \"type\":0, \"crate_name\":\"anstyle\", \"id\":\"anstyle-1_0_10-bf6d032cb7d79be1\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=d705f4887e480dff \
              -C extra-filename=-bf6d032cb7d79be1 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "anstyle-1_0_10-bf6d032cb7d79be1" \
          --arg crate_name "anstyle" \
