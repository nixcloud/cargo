...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "typeid-1_0_2-06b80a723e60dba2";
    meta.cargo_crate_info = {
      name = "typeid";
      version = "1.0.2";
      crate_hash = "06b80a723e60dba2";
      type = "";
    };
    ...
    passthru.rust_crate_parent = [typeid-1_0_2-script_build_run-5defda54e8752cb1];
    passthru.rust_script_build_run = [typeid-1_0_2-script_build_run-5defda54e8752cb1];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=fa07e5c58baee8fb \
              -C extra-filename=-06b80a723e60dba2 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
