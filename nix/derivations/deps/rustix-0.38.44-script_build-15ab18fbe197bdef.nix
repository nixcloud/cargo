...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "rustix-0_38_44-script_build-15ab18fbe197bdef";
    meta.cargo_crate_info = {
      name = "rustix";
      version = "0.38.44";
      crate_hash = "15ab18fbe197bdef";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m rustix-0_38_44-script_build-15ab18fbe197bdef"
      echo "@cargo { \"type\":0, \"crate_name\":\"rustix\", \"id\":\"rustix-0_38_44-script_build-15ab18fbe197bdef\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=a7a19db93615050b \
              -C extra-filename=-15ab18fbe197bdef \
              --out-dir $OUT_DIR \
      ...
      do
          ...
          ${pkgs.jq}/bin/jq -r -c 'select(."$message_type"=="diagnostic") | .rendered' $tmpFile
            ...
            ln -s $OUT_DIR/"$CARGO_CRATE_NAME"-15ab18fbe197bdef $OUT_DIR/build_script_build
      
      # return structured formatted errors for later processing
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "rustix-0_38_44-script_build-15ab18fbe197bdef" \
