...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "pest_meta-2_7_15-d270fb98bcde068c";
    meta.cargo_crate_info = {
      name = "pest_meta";
      version = "2.7.15";
      crate_hash = "d270fb98bcde068c";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [once_cell-1_20_3-469ccbdd2c0eb86a pest-2_7_15-d1d50d7cd3dcc47b];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=4f04c08fdf974c22 \
              -C extra-filename=-d270fb98bcde068c \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern once_cell=${once_cell-1_20_3-469ccbdd2c0eb86a}/libonce_cell-469ccbdd2c0eb86a.rmeta \
