...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "libsqlite3-sys-0_31_0-8e2c6f3f6c420058";
    meta.cargo_crate_info = {
      name = "libsqlite3-sys";
      version = "0.31.0";
      crate_hash = "8e2c6f3f6c420058";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [];
    passthru.rust_crate_parent = [libsqlite3-sys-0_31_0-script_build_run-2e938fb39223d7f4];
    passthru.rust_script_build_run = [libsqlite3-sys-0_31_0-script_build_run-2e938fb39223d7f4];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m libsqlite3-sys-0_31_0-8e2c6f3f6c420058"
      echo "@cargo { \"type\":0, \"crate_name\":\"libsqlite3-sys\", \"id\":\"libsqlite3-sys-0_31_0-8e2c6f3f6c420058\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=e1b37e32c24b0d27 \
              -C extra-filename=-8e2c6f3f6c420058 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "libsqlite3-sys-0_31_0-8e2c6f3f6c420058" \
