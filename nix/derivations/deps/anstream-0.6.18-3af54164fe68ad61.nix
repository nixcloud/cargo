...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "anstream-0_6_18-3af54164fe68ad61";
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              --extern colorchoice=${colorchoice-1_0_3-3fd8e2bb93f5239a}/libcolorchoice-3fd8e2bb93f5239a.rmeta \
              --extern is_terminal_polyfill=${is_terminal_polyfill-1_70_1-38de4a7f1aa06bfb}/libis_terminal_polyfill-38de4a7f1aa06bfb.rmeta \
