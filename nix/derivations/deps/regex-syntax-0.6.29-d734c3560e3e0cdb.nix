...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m regex-syntax-0_6_29-d734c3560e3e0cdb"
      echo "@cargo { \"type\":0, \"crate_name\":\"regex-syntax\", \"id\":\"regex-syntax-0_6_29-d734c3560e3e0cdb\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "regex-syntax-0_6_29-d734c3560e3e0cdb" \
