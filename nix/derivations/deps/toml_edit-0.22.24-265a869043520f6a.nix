...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "toml_edit-0_22_24-265a869043520f6a";
    meta.cargo_crate_info = {
      name = "toml_edit";
      version = "0.22.24";
      crate_hash = "265a869043520f6a";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [indexmap-2_7_1-6b5f2f48a7e1007e serde-1_0_218-ed8707ff8dc168e7 serde_spanned-0_6_8-f8cca0b2ce20b137 toml_datetime-0_6_8-95cf01ad2f83568d winnow-0_7_1-77a2b40bdf68ade2];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=b7b28c79e56f88d0 \
              -C extra-filename=-265a869043520f6a \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              ...
              --extern winnow=${winnow-0_7_1-77a2b40bdf68ade2}/libwinnow-77a2b40bdf68ade2.rmeta \
