...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "rfc6979-0_4_0-efb691326bf41a38";
    meta.cargo_crate_info = {
      name = "rfc6979";
      version = "0.4.0";
      crate_hash = "efb691326bf41a38";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [hmac-0_12_1-bc3929f8e30dab3e subtle-2_6_1-0584afad8ebd85c1];
...
Digital Signature Algorithm (DSA) and Elliptic Curve Digital Signature Algorithm (ECDSA)";
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=afa29ab233fb1767 \
              -C extra-filename=-efb691326bf41a38 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
