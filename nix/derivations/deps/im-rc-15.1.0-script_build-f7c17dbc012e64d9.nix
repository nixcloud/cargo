...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "im-rc-15_1_0-script_build-f7c17dbc012e64d9";
    meta.cargo_crate_info = {
      name = "im-rc";
      version = "15.1.0";
      crate_hash = "f7c17dbc012e64d9";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m im-rc-15_1_0-script_build-f7c17dbc012e64d9"
      echo "@cargo { \"type\":0, \"crate_name\":\"im-rc\", \"id\":\"im-rc-15_1_0-script_build-f7c17dbc012e64d9\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=ac397b4ae76391dc \
              -C extra-filename=-f7c17dbc012e64d9 \
              --out-dir $OUT_DIR \
      ...
      do
          ...
          ${pkgs.jq}/bin/jq -r -c 'select(."$message_type"=="diagnostic") | .rendered' $tmpFile
            ...
            ln -s $OUT_DIR/"$CARGO_CRATE_NAME"-f7c17dbc012e64d9 $OUT_DIR/build_script_build
      
      # return structured formatted errors for later processing
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "im-rc-15_1_0-script_build-f7c17dbc012e64d9" \
