...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m allocator-api2-0_2_21-bd3713078dfee01f"
      echo "@cargo { \"type\":0, \"crate_name\":\"allocator-api2\", \"id\":\"allocator-api2-0_2_21-bd3713078dfee01f\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "allocator-api2-0_2_21-bd3713078dfee01f" \
          --arg crate_name "allocator-api2" \
