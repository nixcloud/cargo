...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "serde_spanned-0_6_8-b8b72c3377341dbf";
    meta.cargo_crate_info = {
      name = "serde_spanned";
      version = "0.6.8";
      crate_hash = "b8b72c3377341dbf";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m serde_spanned-0_6_8-b8b72c3377341dbf"
      echo "@cargo { \"type\":0, \"crate_name\":\"serde_spanned\", \"id\":\"serde_spanned-0_6_8-b8b72c3377341dbf\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=e5823015d53aa5a9 \
              -C extra-filename=-b8b72c3377341dbf \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "serde_spanned-0_6_8-b8b72c3377341dbf" \
          --arg crate_name "serde_spanned" \
