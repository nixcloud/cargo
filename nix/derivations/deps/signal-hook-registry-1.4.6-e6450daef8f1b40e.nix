...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "signal-hook-registry-1_4_6-e6450daef8f1b40e";
    meta.cargo_crate_info = {
      name = "signal-hook-registry";
      version = "1.4.6";
      crate_hash = "e6450daef8f1b40e";
    };
    ...
    src = pkgs.fetchurl {
      url = "https://crates.io/api/v1/crates/signal-hook-registry/1.4.6/download";
      sha256 = "b2a4719bff48cee6b39d12c020eeb490953ad2443b7055bd0b21fca26bd8c28b";
    };
    unpackPhase = ''
      tar xf $src
      cd signal-hook-registry-1.4.6
    '';
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m signal-hook-registry-1_4_6-e6450daef8f1b40e"
      echo "@cargo { \"type\":0, \"crate_name\":\"signal-hook-registry\", \"id\":\"signal-hook-registry-1_4_6-e6450daef8f1b40e\" }"

      rustc_json_output_lines=$(${pkgs.mktemp}/bin/mktemp)
      set -x +e
      ${RUSTC} \
              --crate-name signal_hook_registry \
              ...
              -C metadata=d7ef0d7973dadfff \
              -C extra-filename=-e6450daef8f1b40e \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "signal-hook-registry-1_4_6-e6450daef8f1b40e" \
          --arg crate_name "signal-hook-registry" \
