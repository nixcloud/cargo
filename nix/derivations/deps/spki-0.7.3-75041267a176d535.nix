...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "spki-0_7_3-75041267a176d535";
    meta.cargo_crate_info = {
      name = "spki";
      version = "0.7.3";
      crate_hash = "75041267a176d535";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [der-0_7_9-9223185c0fceb330];
...
associated AlgorithmIdentifiers (i.e. OIDs)";
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=a4fde72d49ec0dbd \
              -C extra-filename=-75041267a176d535 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
