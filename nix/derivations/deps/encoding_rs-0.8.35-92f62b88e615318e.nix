...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m encoding_rs-0_8_35-92f62b88e615318e"
      echo "@cargo { \"type\":0, \"crate_name\":\"encoding_rs\", \"id\":\"encoding_rs-0_8_35-92f62b88e615318e\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "encoding_rs-0_8_35-92f62b88e615318e" \
          --arg crate_name "encoding_rs" \
