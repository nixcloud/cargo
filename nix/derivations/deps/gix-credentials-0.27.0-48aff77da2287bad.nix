...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-credentials-0_27_0-48aff77da2287bad";
    meta.cargo_crate_info = {
      name = "gix-credentials";
      version = "0.27.0";
      crate_hash = "48aff77da2287bad";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bstr-1_11_3-14003bcd5b7b8103 gix-command-0_4_1-e29484d4d4e346e8 gix-config-value-0_14_11-712acc74f435528f gix-path-0_10_14-6bb928c9998da5a8 gix-prompt-0_9_1-fa757bef7affaabd gix-sec-0_10_11-a898e4a50340a006 gix-trace-0_1_12-6fa342b8ee63f664 gix-url-0_29_0-74b20df333b8da83 thiserror-2_0_11-a57592ffa4ea41e0];
    passthru.rust_crate_parent = [];
    passthru.rust_script_build_run = [];
    phases = "unpackPhase buildPhase";

    src = pkgs.fetchurl {
      url = "https://crates.io/api/v1/crates/gix-credentials/0.27.0/download";
      sha256 = "cf950f9ee1690bb9c4388b5152baa8a9f41ad61e5cf1ba0ec8c207b08dab9e45";
    };
    unpackPhase = ''
      tar xf $src
      cd gix-credentials-0.27.0
    '';
    ...
    CARGO_PKG_DESCRIPTION = "A crate of the gitoxide project to interact with git credentials helpers";
    CARGO_PKG_HOMEPAGE = "";
    CARGO_PKG_LICENSE = "MIT OR Apache-2.0";
    CARGO_PKG_LICENSE_FILE = "";
    CARGO_PKG_NAME = "gix-credentials";
    CARGO_PKG_README = "";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-credentials-0_27_0-48aff77da2287bad"
      echo "@cargo { \"type\":0, \"crate_name\":\"gix-credentials\", \"id\":\"gix-credentials-0_27_0-48aff77da2287bad\" }"

      rustc_json_output_lines=$(${pkgs.mktemp}/bin/mktemp)
      set -x +e
      ${RUSTC} \
              --crate-name gix_credentials \
              ...
              -C metadata=468ecb0c20515b74 \
              -C extra-filename=-48aff77da2287bad \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "gix-credentials-0_27_0-48aff77da2287bad" \
          --arg crate_name "gix-credentials" \
