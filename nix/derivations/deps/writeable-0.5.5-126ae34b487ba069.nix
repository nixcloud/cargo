...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "writeable-0_5_5-126ae34b487ba069";
    meta.cargo_crate_info = {
      name = "writeable";
      version = "0.5.5";
      crate_hash = "126ae34b487ba069";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m writeable-0_5_5-126ae34b487ba069"
      echo "@cargo { \"type\":0, \"crate_name\":\"writeable\", \"id\":\"writeable-0_5_5-126ae34b487ba069\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=035ffab73efaa4c8 \
              -C extra-filename=-126ae34b487ba069 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "writeable-0_5_5-126ae34b487ba069" \
          --arg crate_name "writeable" \
