...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m annotate-snippets-0_11_5-4d47bac9cbcd3256"
      echo "@cargo { \"type\":0, \"crate_name\":\"annotate-snippets\", \"id\":\"annotate-snippets-0_11_5-4d47bac9cbcd3256\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "annotate-snippets-0_11_5-4d47bac9cbcd3256" \
          --arg crate_name "annotate-snippets" \
