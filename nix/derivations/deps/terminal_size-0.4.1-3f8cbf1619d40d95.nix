...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "terminal_size-0_4_1-3f8cbf1619d40d95";
    meta.cargo_crate_info = {
      name = "terminal_size";
      version = "0.4.1";
      crate_hash = "3f8cbf1619d40d95";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [rustix-0_38_44-bb44290fdf9a9b11];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=89ee6c0ae3e39fb5 \
              -C extra-filename=-3f8cbf1619d40d95 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
