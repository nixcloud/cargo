...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m tracing-chrome-0_7_2-5b548189b83dd8d2"
      echo "@cargo { \"type\":0, \"crate_name\":\"tracing-chrome\", \"id\":\"tracing-chrome-0_7_2-5b548189b83dd8d2\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "tracing-chrome-0_7_2-5b548189b83dd8d2" \
          --arg crate_name "tracing-chrome" \
