...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m version_check-0_9_5-0f6ab564ae9887d4"
      echo "@cargo { \"type\":0, \"crate_name\":\"version_check\", \"id\":\"version_check-0_9_5-0f6ab564ae9887d4\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "version_check-0_9_5-0f6ab564ae9887d4" \
          --arg crate_name "version_check" \
