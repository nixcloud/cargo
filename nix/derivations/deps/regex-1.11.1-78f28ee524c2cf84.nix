...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "regex-1_11_1-78f28ee524c2cf84";
    meta.cargo_crate_info = {
      name = "regex";
      version = "1.11.1";
      crate_hash = "78f28ee524c2cf84";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [aho-corasick-1_1_3-511789a4780abe8b memchr-2_7_4-a0e5828b48f06e07 regex-automata-0_4_9-09b7fa440d2dfa3a regex-syntax-0_8_5-32c6de4fe11e3b8f];
...
finite automata and guarantees linear time matching on all inputs.";
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=b4454b6e5a64707a \
              -C extra-filename=-78f28ee524c2cf84 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
