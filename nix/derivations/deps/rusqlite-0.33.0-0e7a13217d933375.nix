...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m rusqlite-0_33_0-0e7a13217d933375"
      echo "@cargo { \"type\":0, \"crate_name\":\"rusqlite\", \"id\":\"rusqlite-0_33_0-0e7a13217d933375\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "rusqlite-0_33_0-0e7a13217d933375" \
          --arg crate_name "rusqlite" \
