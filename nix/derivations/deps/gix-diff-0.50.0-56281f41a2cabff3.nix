...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-diff-0_50_0-56281f41a2cabff3";
    meta.cargo_crate_info = {
      name = "gix-diff";
      version = "0.50.0";
      crate_hash = "56281f41a2cabff3";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [bstr-1_11_3-46100c463ffaaa37 gix-hash-0_16_0-d473f2b9165b7ac8 gix-object-0_47_0-d81adbd40609c58b thiserror-2_0_11-c6c4ee382aacde15];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=8a7753b6add24460 \
              -C extra-filename=-56281f41a2cabff3 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
