...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-config-0_43_0-c2a2493ddeeda786"
      echo "@cargo { \"type\":0, \"crate_name\":\"gix-config\", \"id\":\"gix-config-0_43_0-c2a2493ddeeda786\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "gix-config-0_43_0-c2a2493ddeeda786" \
          --arg crate_name "gix-config" \
