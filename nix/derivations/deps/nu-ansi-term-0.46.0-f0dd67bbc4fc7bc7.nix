...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "nu-ansi-term-0_46_0-f0dd67bbc4fc7bc7";
    meta.cargo_crate_info = {
      name = "nu-ansi-term";
      version = "0.46.0";
      crate_hash = "f0dd67bbc4fc7bc7";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [overload-0_1_1-36d6dc4b2c1d5222];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m nu-ansi-term-0_46_0-f0dd67bbc4fc7bc7"
      echo "@cargo { \"type\":0, \"crate_name\":\"nu-ansi-term\", \"id\":\"nu-ansi-term-0_46_0-f0dd67bbc4fc7bc7\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=0722e820548e6e37 \
              -C extra-filename=-f0dd67bbc4fc7bc7 \
              --out-dir $OUT_DIR \
              ${fn.rustc_linker_arguments passthru.rust_crate_libraries} \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              --extern overload=${overload-0_1_1-36d6dc4b2c1d5222}/liboverload-36d6dc4b2c1d5222.rmeta \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "nu-ansi-term-0_46_0-f0dd67bbc4fc7bc7" \
          --arg crate_name "nu-ansi-term" \
