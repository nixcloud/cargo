...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "thiserror-impl-2_0_11-66c29e07c551aa3d";
    meta.cargo_crate_info = {
      name = "thiserror-impl";
      version = "2.0.11";
      crate_hash = "66c29e07c551aa3d";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m thiserror-impl-2_0_11-66c29e07c551aa3d"
      echo "@cargo { \"type\":0, \"crate_name\":\"thiserror-impl\", \"id\":\"thiserror-impl-2_0_11-66c29e07c551aa3d\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=0f9a64afc481029b \
              -C extra-filename=-66c29e07c551aa3d \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "thiserror-impl-2_0_11-66c29e07c551aa3d" \
