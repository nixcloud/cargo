...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "getrandom-0_3_1-f98539da635491d1";
    meta.cargo_crate_info = {
      name = "getrandom";
      version = "0.3.1";
      crate_hash = "f98539da635491d1";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [cfg-if-1_0_0-616d46354eebf850 libc-0_2_175-df0687d6868fdede];
    passthru.rust_crate_parent = [getrandom-0_3_1-script_build_run-63e4c9b982414d98];
    passthru.rust_script_build_run = [getrandom-0_3_1-script_build_run-63e4c9b982414d98];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m getrandom-0_3_1-f98539da635491d1"
      echo "@cargo { \"type\":0, \"crate_name\":\"getrandom\", \"id\":\"getrandom-0_3_1-f98539da635491d1\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=c218846c62d6b75b \
              -C extra-filename=-f98539da635491d1 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "getrandom-0_3_1-f98539da635491d1" \
