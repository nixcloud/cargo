...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "thread_local-1_1_8-c649412a866b5e65";
    meta.cargo_crate_info = {
      name = "thread_local";
      version = "1.1.8";
      crate_hash = "c649412a866b5e65";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [cfg-if-1_0_0-424abd49c6d5f017 once_cell-1_20_3-65600a49c06310f1];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=320e69cecb8611b6 \
              -C extra-filename=-c649412a866b5e65 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
