...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "once_cell-1_20_3-60992a3834e62ae0";
    meta.cargo_crate_info = {
      name = "once_cell";
      version = "1.20.3";
      crate_hash = "60992a3834e62ae0";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m once_cell-1_20_3-60992a3834e62ae0"
      echo "@cargo { \"type\":0, \"crate_name\":\"once_cell\", \"id\":\"once_cell-1_20_3-60992a3834e62ae0\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=4c06b1801ab00a27 \
              -C extra-filename=-60992a3834e62ae0 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "once_cell-1_20_3-60992a3834e62ae0" \
          --arg crate_name "once_cell" \
