...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "clap_complete-4_5_46-4dce9b58b32b4c7b";
    meta.cargo_crate_info = {
      name = "clap_complete";
      version = "4.5.46";
      crate_hash = "4dce9b58b32b4c7b";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [clap-4_5_31-436756512d3af050 clap_lex-0_7_4-ee15bee4b3047b45 is_executable-1_0_4-bee9f7c96c317349 shlex-1_3_0-d9cdabc28e4bcb3e];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=c8c7cdc6c5c44aa2 \
              -C extra-filename=-4dce9b58b32b4c7b \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              ...
              --extern is_executable=${is_executable-1_0_4-bee9f7c96c317349}/libis_executable-bee9f7c96c317349.rmeta \
              --extern shlex=${shlex-1_3_0-d9cdabc28e4bcb3e}/libshlex-d9cdabc28e4bcb3e.rmeta \
