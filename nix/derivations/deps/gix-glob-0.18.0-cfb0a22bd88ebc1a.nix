...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-glob-0_18_0-cfb0a22bd88ebc1a";
    meta.cargo_crate_info = {
      name = "gix-glob";
      version = "0.18.0";
      crate_hash = "cfb0a22bd88ebc1a";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [bitflags-2_8_0-25bacb8b683e4264 bstr-1_11_3-46100c463ffaaa37 gix-features-0_40_0-786b5f2993cbc7d3 gix-path-0_10_14-fac4f7c597a0c8bd];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=44cd573237f986cb \
              -C extra-filename=-cfb0a22bd88ebc1a \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
