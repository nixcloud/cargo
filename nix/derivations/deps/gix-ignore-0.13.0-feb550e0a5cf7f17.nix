...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-ignore-0_13_0-feb550e0a5cf7f17";
    meta.cargo_crate_info = {
      name = "gix-ignore";
      version = "0.13.0";
      crate_hash = "feb550e0a5cf7f17";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [bstr-1_11_3-46100c463ffaaa37 gix-glob-0_18_0-cfb0a22bd88ebc1a gix-path-0_10_14-fac4f7c597a0c8bd gix-trace-0_1_12-718f68523d5ac749 unicode-bom-2_0_3-0618da7d75fc7211];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=d20b9a74387f2e73 \
              -C extra-filename=-feb550e0a5cf7f17 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
