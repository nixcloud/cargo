...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m litemap-0_7_4-1f4d69d5dc04ca70"
      echo "@cargo { \"type\":0, \"crate_name\":\"litemap\", \"id\":\"litemap-0_7_4-1f4d69d5dc04ca70\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "litemap-0_7_4-1f4d69d5dc04ca70" \
          --arg crate_name "litemap" \
