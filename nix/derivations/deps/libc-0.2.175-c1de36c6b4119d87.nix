...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "libc-0_2_175-c1de36c6b4119d87";
    meta.cargo_crate_info = {
      name = "libc";
      version = "0.2.175";
      crate_hash = "c1de36c6b4119d87";
      type = "";
    };
    ...
    passthru.rust_crate_parent = [libc-0_2_175-script_build_run-b778f13adc7035ee];
    passthru.rust_script_build_run = [libc-0_2_175-script_build_run-b778f13adc7035ee];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=f43f6b3c7885fce7 \
              -C extra-filename=-c1de36c6b4119d87 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
