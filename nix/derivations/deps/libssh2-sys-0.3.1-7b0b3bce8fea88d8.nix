...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m libssh2-sys-0_3_1-7b0b3bce8fea88d8"
      echo "@cargo { \"type\":0, \"crate_name\":\"libssh2-sys\", \"id\":\"libssh2-sys-0_3_1-7b0b3bce8fea88d8\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "libssh2-sys-0_3_1-7b0b3bce8fea88d8" \
