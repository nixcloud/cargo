...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "ordered-float-2_10_1-9038a1abe48f7d3f";
    meta.cargo_crate_info = {
      name = "ordered-float";
      version = "2.10.1";
      crate_hash = "9038a1abe48f7d3f";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [num-traits-0_2_19-e470ad1dd03fa99a];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=0c9cb12cc4230020 \
              -C extra-filename=-9038a1abe48f7d3f \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
