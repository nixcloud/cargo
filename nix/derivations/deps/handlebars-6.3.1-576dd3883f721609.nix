...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "handlebars-6_3_1-576dd3883f721609";
    meta.cargo_crate_info = {
      name = "handlebars";
      version = "6.3.1";
      crate_hash = "576dd3883f721609";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [derive_builder-0_20_2-55d9f78f8009441b log-0_4_25-fde7ab722b325b0e num-order-1_2_0-eff9366d228c9b94 pest-2_7_15-59e44ce85cf440fb pest_derive-2_7_15-928e1e57d91e264c serde-1_0_218-ed8707ff8dc168e7 serde_json-1_0_139-17182eb61f3853cc thiserror-2_0_11-c6c4ee382aacde15 walkdir-2_5_0-1df263e29c1f7c83];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=ce9fa139fccea762 \
              -C extra-filename=-576dd3883f721609 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern derive_builder=${derive_builder-0_20_2-55d9f78f8009441b}/libderive_builder-55d9f78f8009441b.rmeta \
              --extern log=${log-0_4_25-fde7ab722b325b0e}/liblog-fde7ab722b325b0e.rmeta \
              --extern num_order=${num-order-1_2_0-eff9366d228c9b94}/libnum_order-eff9366d228c9b94.rmeta \
              --extern pest=${pest-2_7_15-59e44ce85cf440fb}/libpest-59e44ce85cf440fb.rmeta \
              --extern pest_derive=${pest_derive-2_7_15-928e1e57d91e264c}/libpest_derive-928e1e57d91e264c.so \
