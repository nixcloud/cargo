...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "libz-sys-1_1_21-4cbe081b1eadb6dd";
    meta.cargo_crate_info = {
      name = "libz-sys";
      version = "1.1.21";
      crate_hash = "4cbe081b1eadb6dd";
      type = "";
    };
    ...
    passthru.rust_crate_parent = [libz-sys-1_1_21-script_build_run-685e49eac1c25b95];
    passthru.rust_script_build_run = [libz-sys-1_1_21-script_build_run-685e49eac1c25b95];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=2ebb39ae441e7e07 \
              -C extra-filename=-4cbe081b1eadb6dd \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
