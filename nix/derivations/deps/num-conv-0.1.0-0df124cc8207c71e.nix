...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "num-conv-0_1_0-0df124cc8207c71e";
    meta.cargo_crate_info = {
      name = "num-conv";
      version = "0.1.0";
      crate_hash = "0df124cc8207c71e";
    };
...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m num-conv-0_1_0-0df124cc8207c71e"
      echo "@cargo { \"type\":0, \"crate_name\":\"num-conv\", \"id\":\"num-conv-0_1_0-0df124cc8207c71e\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=be38ddf215200887 \
              -C extra-filename=-0df124cc8207c71e \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "num-conv-0_1_0-0df124cc8207c71e" \
          --arg crate_name "num-conv" \
