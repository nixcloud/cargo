...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-date-0_9_3-6d0773e8f7ea4157";
    meta.cargo_crate_info = {
      name = "gix-date";
      version = "0.9.3";
      crate_hash = "6d0773e8f7ea4157";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [bstr-1_11_3-46100c463ffaaa37 itoa-1_0_14-f807d60e93b08a94 jiff-0_1_29-41b3bef036432895 thiserror-2_0_11-c6c4ee382aacde15];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=027b3dfdbb9963e6 \
              -C extra-filename=-6d0773e8f7ea4157 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              ...
              --extern jiff=${jiff-0_1_29-41b3bef036432895}/libjiff-41b3bef036432895.rmeta \
