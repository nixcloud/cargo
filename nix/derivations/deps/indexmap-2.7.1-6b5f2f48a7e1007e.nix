...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "indexmap-2_7_1-6b5f2f48a7e1007e";
    meta.cargo_crate_info = {
      name = "indexmap";
      version = "2.7.1";
      crate_hash = "6b5f2f48a7e1007e";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [equivalent-1_0_1-10c35e6cce698ddd hashbrown-0_15_2-6ab6a36ed920f298];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=563602e1f2b669c9 \
              -C extra-filename=-6b5f2f48a7e1007e \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern equivalent=${equivalent-1_0_1-10c35e6cce698ddd}/libequivalent-10c35e6cce698ddd.rmeta \
              --extern hashbrown=${hashbrown-0_15_2-6ab6a36ed920f298}/libhashbrown-6ab6a36ed920f298.rmeta \
