...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "crossbeam-deque-0_8_6-71d6deff62d4a66b";
    meta.cargo_crate_info = {
      name = "crossbeam-deque";
      version = "0.8.6";
      crate_hash = "71d6deff62d4a66b";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [crossbeam-epoch-0_9_18-ddc627cd5d25a336 crossbeam-utils-0_8_21-33005183671c1b28];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=07339d8cc76d5342 \
              -C extra-filename=-71d6deff62d4a66b \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern crossbeam_epoch=${crossbeam-epoch-0_9_18-ddc627cd5d25a336}/libcrossbeam_epoch-ddc627cd5d25a336.rmeta \
