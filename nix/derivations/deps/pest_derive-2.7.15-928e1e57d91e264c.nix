...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "pest_derive-2_7_15-928e1e57d91e264c";
    meta.cargo_crate_info = {
      name = "pest_derive";
      version = "2.7.15";
      crate_hash = "928e1e57d91e264c";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [pest-2_7_15-d1d50d7cd3dcc47b pest_generator-2_7_15-85e6b47a9be60b20];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=153ea7b9454a8516 \
              -C extra-filename=-928e1e57d91e264c \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern pest=${pest-2_7_15-d1d50d7cd3dcc47b}/libpest-d1d50d7cd3dcc47b.rlib \
              --extern pest_generator=${pest_generator-2_7_15-85e6b47a9be60b20}/libpest_generator-85e6b47a9be60b20.rlib \
              --extern proc_macro \
