...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "sized-chunks-0_6_5-e757fe722119bf9b";
    meta.cargo_crate_info = {
      name = "sized-chunks";
      version = "0.6.5";
      crate_hash = "e757fe722119bf9b";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bitmaps-2_1_0-f1176e47abd2310d typenum-1_17_0-34b9dff24cc50896];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m sized-chunks-0_6_5-e757fe722119bf9b"
      echo "@cargo { \"type\":0, \"crate_name\":\"sized-chunks\", \"id\":\"sized-chunks-0_6_5-e757fe722119bf9b\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=ca89d174be5106c6 \
              -C extra-filename=-e757fe722119bf9b \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "sized-chunks-0_6_5-e757fe722119bf9b" \
          --arg crate_name "sized-chunks" \
