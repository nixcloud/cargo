...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "sha1-0_10_6-7f98ce853a3fd8dc";
    meta.cargo_crate_info = {
      name = "sha1";
      version = "0.10.6";
      crate_hash = "7f98ce853a3fd8dc";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m sha1-0_10_6-7f98ce853a3fd8dc"
      echo "@cargo { \"type\":0, \"crate_name\":\"sha1\", \"id\":\"sha1-0_10_6-7f98ce853a3fd8dc\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=b2605dc09fe2d6b6 \
              -C extra-filename=-7f98ce853a3fd8dc \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "sha1-0_10_6-7f98ce853a3fd8dc" \
          --arg crate_name "sha1" \
