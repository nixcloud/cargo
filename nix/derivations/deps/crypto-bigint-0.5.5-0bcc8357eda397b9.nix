...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "crypto-bigint-0_5_5-0bcc8357eda397b9";
    meta.cargo_crate_info = {
      name = "crypto-bigint";
      version = "0.5.5";
      crate_hash = "0bcc8357eda397b9";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [generic-array-0_14_7-28e5836782b73319 rand_core-0_6_4-fb3f0a376173ae44 subtle-2_6_1-0584afad8ebd85c1 zeroize-1_8_1-966e26bee9773779];
...
no_std-friendly implementations of modern formulas using const generics.";
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=976db2e0a381e15d \
              -C extra-filename=-0bcc8357eda397b9 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
