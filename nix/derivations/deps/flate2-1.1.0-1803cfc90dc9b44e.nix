...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "flate2-1_1_0-1803cfc90dc9b44e";
    meta.cargo_crate_info = {
      name = "flate2";
      version = "1.1.0";
      crate_hash = "1803cfc90dc9b44e";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [crc32fast-1_4_2-74097b32b99506ae libz-sys-1_1_21-4cbe081b1eadb6dd];
...
and raw deflate streams.";
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=427976d86a0ebf79 \
              -C extra-filename=-1803cfc90dc9b44e \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern crc32fast=${crc32fast-1_4_2-74097b32b99506ae}/libcrc32fast-74097b32b99506ae.rmeta \
              --extern libz_sys=${libz-sys-1_1_21-4cbe081b1eadb6dd}/liblibz_sys-4cbe081b1eadb6dd.rmeta \
