...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "block-buffer-0_10_4-8ecc6e390505da10";
    meta.cargo_crate_info = {
      name = "block-buffer";
      version = "0.10.4";
      crate_hash = "8ecc6e390505da10";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [generic-array-0_14_7-cf1af5fa7e31ffd0];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m block-buffer-0_10_4-8ecc6e390505da10"
      echo "@cargo { \"type\":0, \"crate_name\":\"block-buffer\", \"id\":\"block-buffer-0_10_4-8ecc6e390505da10\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=8ff6287e6bbbbba9 \
              -C extra-filename=-8ecc6e390505da10 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "block-buffer-0_10_4-8ecc6e390505da10" \
          --arg crate_name "block-buffer" \
