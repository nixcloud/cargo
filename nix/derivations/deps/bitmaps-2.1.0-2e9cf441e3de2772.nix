...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "bitmaps-2_1_0-2e9cf441e3de2772";
    meta.cargo_crate_info = {
      name = "bitmaps";
      version = "2.1.0";
      crate_hash = "2e9cf441e3de2772";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [typenum-1_17_0-2372da56c1d08181];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=febaad376fa27b8b \
              -C extra-filename=-2e9cf441e3de2772 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
