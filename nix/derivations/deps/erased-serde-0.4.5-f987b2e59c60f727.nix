...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m erased-serde-0_4_5-f987b2e59c60f727"
      echo "@cargo { \"type\":0, \"crate_name\":\"erased-serde\", \"id\":\"erased-serde-0_4_5-f987b2e59c60f727\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "erased-serde-0_4_5-f987b2e59c60f727" \
          --arg crate_name "erased-serde" \
