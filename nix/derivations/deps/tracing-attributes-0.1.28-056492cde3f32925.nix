...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "tracing-attributes-0_1_28-056492cde3f32925";
    meta.cargo_crate_info = {
      name = "tracing-attributes";
      version = "0.1.28";
      crate_hash = "056492cde3f32925";
    };
...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m tracing-attributes-0_1_28-056492cde3f32925"
      echo "@cargo { \"type\":0, \"crate_name\":\"tracing-attributes\", \"id\":\"tracing-attributes-0_1_28-056492cde3f32925\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=8ae6d46ad51cc1e5 \
              -C extra-filename=-056492cde3f32925 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "tracing-attributes-0_1_28-056492cde3f32925" \
          --arg crate_name "tracing-attributes" \
