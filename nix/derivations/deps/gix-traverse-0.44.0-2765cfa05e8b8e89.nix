...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-traverse-0_44_0-2765cfa05e8b8e89"
      echo "@cargo { \"type\":0, \"crate_name\":\"gix-traverse\", \"id\":\"gix-traverse-0_44_0-2765cfa05e8b8e89\" }"

      rustc_json_output_lines=$(${pkgs.mktemp}/bin/mktemp)
      set -x +e
      ${RUSTC} \
              --crate-name gix_traverse \
              ...
              -C metadata=6b0e2dcef6af7255 \
              -C extra-filename=-2765cfa05e8b8e89 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "gix-traverse-0_44_0-2765cfa05e8b8e89" \
          --arg crate_name "gix-traverse" \
