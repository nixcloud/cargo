...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "openssl-sys-0_9_106-fe430717cd107543";
    meta.cargo_crate_info = {
      name = "openssl-sys";
      version = "0.9.106";
      crate_hash = "fe430717cd107543";
      type = "";
    };
    ...
    passthru.rust_crate_parent = [openssl-sys-0_9_106-script_build_run-f0141b8f842986bf];
    passthru.rust_script_build_run = [openssl-sys-0_9_106-script_build_run-f0141b8f842986bf];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=07614432effc2057 \
              -C extra-filename=-fe430717cd107543 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
