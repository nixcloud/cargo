...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "rand_xoshiro-0_6_0-85d0bd006bb29f8e";
    meta.cargo_crate_info = {
      name = "rand_xoshiro";
      version = "0.6.0";
      crate_hash = "85d0bd006bb29f8e";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [rand_core-0_6_4-fb3f0a376173ae44];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=07260db1da1c8f23 \
              -C extra-filename=-85d0bd006bb29f8e \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
