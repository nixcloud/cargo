...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "libz-sys-1_1_21-69f52d4cc5a20a24";
    meta.cargo_crate_info = {
      name = "libz-sys";
      version = "1.1.21";
      crate_hash = "69f52d4cc5a20a24";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [libc-0_2_175-df0687d6868fdede];
    passthru.rust_crate_parent = [libz-sys-1_1_21-script_build_run-06993c87126df69f];
    passthru.rust_script_build_run = [libz-sys-1_1_21-script_build_run-06993c87126df69f];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m libz-sys-1_1_21-69f52d4cc5a20a24"
      echo "@cargo { \"type\":0, \"crate_name\":\"libz-sys\", \"id\":\"libz-sys-1_1_21-69f52d4cc5a20a24\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=e1c1f58fcc882c23 \
              -C extra-filename=-69f52d4cc5a20a24 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "libz-sys-1_1_21-69f52d4cc5a20a24" \
