...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m fastrand-2_3_0-02ab7f4546011650"
      echo "@cargo { \"type\":0, \"crate_name\":\"fastrand\", \"id\":\"fastrand-2_3_0-02ab7f4546011650\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "fastrand-2_3_0-02ab7f4546011650" \
          --arg crate_name "fastrand" \
