...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "unicode-ident-1_0_17-19b9bf45cc26c223";
    meta.cargo_crate_info = {
      name = "unicode-ident";
      version = "1.0.17";
      crate_hash = "19b9bf45cc26c223";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m unicode-ident-1_0_17-19b9bf45cc26c223"
      echo "@cargo { \"type\":0, \"crate_name\":\"unicode-ident\", \"id\":\"unicode-ident-1_0_17-19b9bf45cc26c223\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=65dfa35744cded09 \
              -C extra-filename=-19b9bf45cc26c223 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "unicode-ident-1_0_17-19b9bf45cc26c223" \
          --arg crate_name "unicode-ident" \
