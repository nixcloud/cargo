...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "tinyvec-1_8_1-eb639ac0d54a4875";
    meta.cargo_crate_info = {
      name = "tinyvec";
      version = "1.8.1";
      crate_hash = "eb639ac0d54a4875";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [tinyvec_macros-0_1_1-f3f6efb33c1e7caa];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m tinyvec-1_8_1-eb639ac0d54a4875"
      echo "@cargo { \"type\":0, \"crate_name\":\"tinyvec\", \"id\":\"tinyvec-1_8_1-eb639ac0d54a4875\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=86d690c1fa66136f \
              -C extra-filename=-eb639ac0d54a4875 \
              --out-dir $OUT_DIR \
              ${fn.rustc_linker_arguments passthru.rust_crate_libraries} \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              --extern tinyvec_macros=${tinyvec_macros-0_1_1-f3f6efb33c1e7caa}/libtinyvec_macros-f3f6efb33c1e7caa.rmeta \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "tinyvec-1_8_1-eb639ac0d54a4875" \
          --arg crate_name "tinyvec" \
