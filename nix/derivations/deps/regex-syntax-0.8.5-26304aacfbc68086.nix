...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "regex-syntax-0_8_5-26304aacfbc68086";
    meta.cargo_crate_info = {
      name = "regex-syntax";
      version = "0.8.5";
      crate_hash = "26304aacfbc68086";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m regex-syntax-0_8_5-26304aacfbc68086"
      echo "@cargo { \"type\":0, \"crate_name\":\"regex-syntax\", \"id\":\"regex-syntax-0_8_5-26304aacfbc68086\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=2bb6f2a43bc41de5 \
              -C extra-filename=-26304aacfbc68086 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "regex-syntax-0_8_5-26304aacfbc68086" \
          --arg crate_name "regex-syntax" \
