...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "sha1_smol-1_0_1-44d22cb8cb02d9b3";
    meta.cargo_crate_info = {
      name = "sha1_smol";
      version = "1.0.1";
      crate_hash = "44d22cb8cb02d9b3";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m sha1_smol-1_0_1-44d22cb8cb02d9b3"
      echo "@cargo { \"type\":0, \"crate_name\":\"sha1_smol\", \"id\":\"sha1_smol-1_0_1-44d22cb8cb02d9b3\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=72583662da32a489 \
              -C extra-filename=-44d22cb8cb02d9b3 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "sha1_smol-1_0_1-44d22cb8cb02d9b3" \
          --arg crate_name "sha1_smol" \
