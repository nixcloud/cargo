...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "indoc-2_0_6-3e36bbc9b09ee6b1";
    meta.cargo_crate_info = {
      name = "indoc";
      version = "2.0.6";
      crate_hash = "3e36bbc9b09ee6b1";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m indoc-2_0_6-3e36bbc9b09ee6b1"
      echo "@cargo { \"type\":0, \"crate_name\":\"indoc\", \"id\":\"indoc-2_0_6-3e36bbc9b09ee6b1\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=4ad551a0c19f232b \
              -C extra-filename=-3e36bbc9b09ee6b1 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "indoc-2_0_6-3e36bbc9b09ee6b1" \
          --arg crate_name "indoc" \
