...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m icu_locid-1_5_0-294b75cdeaebd083"
      echo "@cargo { \"type\":0, \"crate_name\":\"icu_locid\", \"id\":\"icu_locid-1_5_0-294b75cdeaebd083\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "icu_locid-1_5_0-294b75cdeaebd083" \
          --arg crate_name "icu_locid" \
