...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "thiserror-2_0_11-e8a246e25e4f6dfd";
    meta.cargo_crate_info = {
      name = "thiserror";
      version = "2.0.11";
      crate_hash = "e8a246e25e4f6dfd";
      type = "";
    };
    ...
    passthru.rust_crate_parent = [thiserror-2_0_11-script_build_run-8296f45a178e6d2d];
    passthru.rust_script_build_run = [thiserror-2_0_11-script_build_run-8296f45a178e6d2d];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=f6ef24265fde6078 \
              -C extra-filename=-e8a246e25e4f6dfd \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
