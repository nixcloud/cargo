...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "regex-automata-0_4_9-09b7fa440d2dfa3a";
    meta.cargo_crate_info = {
      name = "regex-automata";
      version = "0.4.9";
      crate_hash = "09b7fa440d2dfa3a";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [aho-corasick-1_1_3-511789a4780abe8b memchr-2_7_4-a0e5828b48f06e07 regex-syntax-0_8_5-32c6de4fe11e3b8f];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=cbd6f5059c346c6e \
              -C extra-filename=-09b7fa440d2dfa3a \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
