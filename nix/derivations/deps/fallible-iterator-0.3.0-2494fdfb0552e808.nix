...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m fallible-iterator-0_3_0-2494fdfb0552e808"
      echo "@cargo { \"type\":0, \"crate_name\":\"fallible-iterator\", \"id\":\"fallible-iterator-0_3_0-2494fdfb0552e808\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "fallible-iterator-0_3_0-2494fdfb0552e808" \
          --arg crate_name "fallible-iterator" \
