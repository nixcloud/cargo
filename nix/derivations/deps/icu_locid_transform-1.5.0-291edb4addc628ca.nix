...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "icu_locid_transform-1_5_0-291edb4addc628ca";
    meta.cargo_crate_info = {
      name = "icu_locid_transform";
      version = "1.5.0";
      crate_hash = "291edb4addc628ca";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [displaydoc-0_2_5-a3932aec884d58b9 icu_locid-1_5_0-294b75cdeaebd083 icu_locid_transform_data-1_5_0-13b6af6aebf3cbc0 icu_provider-1_5_0-df823559bbe57634 tinystr-0_7_6-887be2ca1a583610 zerovec-0_10_4-e3e96206699c2afa];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m icu_locid_transform-1_5_0-291edb4addc628ca"
      echo "@cargo { \"type\":0, \"crate_name\":\"icu_locid_transform\", \"id\":\"icu_locid_transform-1_5_0-291edb4addc628ca\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=614f8cf076ddd796 \
              -C extra-filename=-291edb4addc628ca \
              --out-dir $OUT_DIR \
              ...
              --extern icu_locid_transform_data=${icu_locid_transform_data-1_5_0-13b6af6aebf3cbc0}/libicu_locid_transform_data-13b6af6aebf3cbc0.rmeta \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "icu_locid_transform-1_5_0-291edb4addc628ca" \
          --arg crate_name "icu_locid_transform" \
