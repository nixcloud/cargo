...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m same-file-1_0_6-82920d733726b0a3"
      echo "@cargo { \"type\":0, \"crate_name\":\"same-file\", \"id\":\"same-file-1_0_6-82920d733726b0a3\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "same-file-1_0_6-82920d733726b0a3" \
          --arg crate_name "same-file" \
