...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m curl-0_4_47-script_build-9620d559725db5b1"
      echo "@cargo { \"type\":0, \"crate_name\":\"curl\", \"id\":\"curl-0_4_47-script_build-9620d559725db5b1\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "curl-0_4_47-script_build-9620d559725db5b1" \
          --arg crate_name "curl" \
