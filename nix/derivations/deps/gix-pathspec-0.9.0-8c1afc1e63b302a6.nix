...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-pathspec-0_9_0-8c1afc1e63b302a6";
    meta.cargo_crate_info = {
      name = "gix-pathspec";
      version = "0.9.0";
      crate_hash = "8c1afc1e63b302a6";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bitflags-2_8_0-d8308ebf07e22afd bstr-1_11_3-14003bcd5b7b8103 gix-attributes-0_24_0-b71cf5283dcbf9ad gix-config-value-0_14_11-712acc74f435528f gix-glob-0_18_0-7b254994b5e9c6fa gix-path-0_10_14-6bb928c9998da5a8 thiserror-2_0_11-a57592ffa4ea41e0];
    passthru.rust_crate_parent = [];
    passthru.rust_script_build_run = [];
    phases = "unpackPhase buildPhase";

    src = pkgs.fetchurl {
      url = "https://crates.io/api/v1/crates/gix-pathspec/0.9.0/download";
      sha256 = "6430d3a686c08e9d59019806faa78c17315fe22ae73151a452195857ca02f86c";
    };
    unpackPhase = ''
      tar xf $src
      cd gix-pathspec-0.9.0
    '';

    RUSTC = "${rustc}/bin/rustc";
    CARGO = "${cargo}/bin/cargo";

    CARGO_CRATE_NAME = "gix_pathspec";
    CARGO_MANIFEST_DIR = "./";
    CARGO_MANIFEST_PATH = "./Cargo.toml";
    CARGO_PKG_AUTHORS = "Sebastian Thiel <sebastian.thiel@icloud.com>";
    CARGO_PKG_DESCRIPTION = "A crate of the gitoxide project dealing magical pathspecs";
    CARGO_PKG_HOMEPAGE = "";
    CARGO_PKG_LICENSE = "MIT OR Apache-2.0";
    CARGO_PKG_LICENSE_FILE = "";
    CARGO_PKG_NAME = "gix-pathspec";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-pathspec-0_9_0-8c1afc1e63b302a6"
      echo "@cargo { \"type\":0, \"crate_name\":\"gix-pathspec\", \"id\":\"gix-pathspec-0_9_0-8c1afc1e63b302a6\" }"

      rustc_json_output_lines=$(${pkgs.mktemp}/bin/mktemp)
      set -x +e
      ${RUSTC} \
              --crate-name gix_pathspec \
              ...
              -C metadata=87a11f37ffcee81b \
              -C extra-filename=-8c1afc1e63b302a6 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "gix-pathspec-0_9_0-8c1afc1e63b302a6" \
          --arg crate_name "gix-pathspec" \
