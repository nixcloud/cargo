...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "anyhow-1_0_96-script_build-118337b27fb502c0";
    meta.cargo_crate_info = {
      name = "anyhow";
      version = "1.0.96";
      crate_hash = "118337b27fb502c0";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m anyhow-1_0_96-script_build-118337b27fb502c0"
      echo "@cargo { \"type\":0, \"crate_name\":\"anyhow\", \"id\":\"anyhow-1_0_96-script_build-118337b27fb502c0\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=48f7625f6892af6b \
              -C extra-filename=-118337b27fb502c0 \
              --out-dir $OUT_DIR \
      ...
      do
          ...
          ${pkgs.jq}/bin/jq -r -c 'select(."$message_type"=="diagnostic") | .rendered' $tmpFile
            ...
            ln -s $OUT_DIR/"$CARGO_CRATE_NAME"-118337b27fb502c0 $OUT_DIR/build_script_build
      
      # return structured formatted errors for later processing
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "anyhow-1_0_96-script_build-118337b27fb502c0" \
