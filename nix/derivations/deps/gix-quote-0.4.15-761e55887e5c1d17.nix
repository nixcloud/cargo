...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-quote-0_4_15-761e55887e5c1d17";
    meta.cargo_crate_info = {
      name = "gix-quote";
      version = "0.4.15";
      crate_hash = "761e55887e5c1d17";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [bstr-1_11_3-46100c463ffaaa37 gix-utils-0_1_14-1374b61d28fc65a7 thiserror-2_0_11-c6c4ee382aacde15];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=1c0e2cdd380890d7 \
              -C extra-filename=-761e55887e5c1d17 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
