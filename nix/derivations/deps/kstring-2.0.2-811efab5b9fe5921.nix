...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m kstring-2_0_2-811efab5b9fe5921"
      echo "@cargo { \"type\":0, \"crate_name\":\"kstring\", \"id\":\"kstring-2_0_2-811efab5b9fe5921\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "kstring-2_0_2-811efab5b9fe5921" \
          --arg crate_name "kstring" \
