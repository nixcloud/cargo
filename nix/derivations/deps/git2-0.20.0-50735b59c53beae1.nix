...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "git2-0_20_0-50735b59c53beae1";
    meta.cargo_crate_info = {
      name = "git2";
      version = "0.20.0";
      crate_hash = "50735b59c53beae1";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [bitflags-2_8_0-25bacb8b683e4264 libc-0_2_175-b265bb513a0388f3 libgit2-sys-0_18_0_plus_1_9_0-7c92f3a3d35092c8 log-0_4_25-fde7ab722b325b0e openssl-probe-0_1_6-2b78ced4e82f241d openssl-sys-0_9_106-fe430717cd107543 url-2_5_4-659fce6bf9b29cb7];
...
repositories.";
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=8aba724193495883 \
              -C extra-filename=-50735b59c53beae1 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
