...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m unicode-bom-2_0_3-c41344f0afa7072b"
      echo "@cargo { \"type\":0, \"crate_name\":\"unicode-bom\", \"id\":\"unicode-bom-2_0_3-c41344f0afa7072b\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "unicode-bom-2_0_3-c41344f0afa7072b" \
          --arg crate_name "unicode-bom" \
