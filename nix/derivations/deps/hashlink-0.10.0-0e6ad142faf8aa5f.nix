...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "hashlink-0_10_0-0e6ad142faf8aa5f";
    meta.cargo_crate_info = {
      name = "hashlink";
      version = "0.10.0";
      crate_hash = "0e6ad142faf8aa5f";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [hashbrown-0_15_2-6ab6a36ed920f298];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=ace89a3df92850a1 \
              -C extra-filename=-0e6ad142faf8aa5f \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
