...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "unicode-normalization-0_1_24-d55d29ecb6c4fe97";
    meta.cargo_crate_info = {
      name = "unicode-normalization";
      version = "0.1.24";
      crate_hash = "d55d29ecb6c4fe97";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [tinyvec-1_8_1-eb639ac0d54a4875];
...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m unicode-normalization-0_1_24-d55d29ecb6c4fe97"
      echo "@cargo { \"type\":0, \"crate_name\":\"unicode-normalization\", \"id\":\"unicode-normalization-0_1_24-d55d29ecb6c4fe97\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=0c08648fbdb853be \
              -C extra-filename=-d55d29ecb6c4fe97 \
              --out-dir $OUT_DIR \
              ${fn.rustc_linker_arguments passthru.rust_crate_libraries} \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              --extern tinyvec=${tinyvec-1_8_1-eb639ac0d54a4875}/libtinyvec-eb639ac0d54a4875.rmeta \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "unicode-normalization-0_1_24-d55d29ecb6c4fe97" \
          --arg crate_name "unicode-normalization" \
