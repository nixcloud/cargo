...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m utf16_iter-1_0_5-e2c4d90fc6d42e47"
      echo "@cargo { \"type\":0, \"crate_name\":\"utf16_iter\", \"id\":\"utf16_iter-1_0_5-e2c4d90fc6d42e47\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "utf16_iter-1_0_5-e2c4d90fc6d42e47" \
          --arg crate_name "utf16_iter" \
