...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "pest-2_7_15-59e44ce85cf440fb";
    meta.cargo_crate_info = {
      name = "pest";
      version = "2.7.15";
      crate_hash = "59e44ce85cf440fb";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [memchr-2_7_4-a0e5828b48f06e07 thiserror-2_0_11-c6c4ee382aacde15 ucd-trie-0_1_7-e40b6b81debbe578];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=8620335a61aa2245 \
              -C extra-filename=-59e44ce85cf440fb \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              ...
              --extern ucd_trie=${ucd-trie-0_1_7-e40b6b81debbe578}/libucd_trie-e40b6b81debbe578.rmeta \
