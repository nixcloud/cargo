...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "primeorder-0_13_6-348bf520b75b2852";
    meta.cargo_crate_info = {
      name = "primeorder";
      version = "0.13.6";
      crate_hash = "348bf520b75b2852";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [elliptic-curve-0_13_8-62624c894feb112b];
...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m primeorder-0_13_6-348bf520b75b2852"
      echo "@cargo { \"type\":0, \"crate_name\":\"primeorder\", \"id\":\"primeorder-0_13_6-348bf520b75b2852\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=0ebd0b2e8f0c378c \
              -C extra-filename=-348bf520b75b2852 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "primeorder-0_13_6-348bf520b75b2852" \
          --arg crate_name "primeorder" \
