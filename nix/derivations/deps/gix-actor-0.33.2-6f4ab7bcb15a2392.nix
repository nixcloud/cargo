...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-actor-0_33_2-6f4ab7bcb15a2392";
    meta.cargo_crate_info = {
      name = "gix-actor";
      version = "0.33.2";
      crate_hash = "6f4ab7bcb15a2392";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bstr-1_11_3-14003bcd5b7b8103 gix-date-0_9_3-ef3873a712c7b7c9 gix-utils-0_1_14-4da59f2b8afebe0a itoa-1_0_14-6ae7bc765ab6d9fa thiserror-2_0_11-a57592ffa4ea41e0 winnow-0_6_26-83cf2fecf0abf70e];
    passthru.rust_crate_parent = [];
    passthru.rust_script_build_run = [];
    phases = "unpackPhase buildPhase";

    src = pkgs.fetchurl {
      url = "https://crates.io/api/v1/crates/gix-actor/0.33.2/download";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-actor-0_33_2-6f4ab7bcb15a2392"
      echo "@cargo { \"type\":0, \"crate_name\":\"gix-actor\", \"id\":\"gix-actor-0_33_2-6f4ab7bcb15a2392\" }"

      rustc_json_output_lines=$(${pkgs.mktemp}/bin/mktemp)
      set -x +e
      ${RUSTC} \
              --crate-name gix_actor \
              ...
              -C metadata=e8ad7e389c154a94 \
              -C extra-filename=-6f4ab7bcb15a2392 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "gix-actor-0_33_2-6f4ab7bcb15a2392" \
          --arg crate_name "gix-actor" \
