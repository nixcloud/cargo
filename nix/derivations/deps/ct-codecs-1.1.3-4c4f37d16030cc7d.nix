...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m ct-codecs-1_1_3-4c4f37d16030cc7d"
      echo "@cargo { \"type\":0, \"crate_name\":\"ct-codecs\", \"id\":\"ct-codecs-1_1_3-4c4f37d16030cc7d\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "ct-codecs-1_1_3-4c4f37d16030cc7d" \
          --arg crate_name "ct-codecs" \
