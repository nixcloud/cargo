...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m icu_provider-1_5_0-df823559bbe57634"
      echo "@cargo { \"type\":0, \"crate_name\":\"icu_provider\", \"id\":\"icu_provider-1_5_0-df823559bbe57634\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "icu_provider-1_5_0-df823559bbe57634" \
          --arg crate_name "icu_provider" \
