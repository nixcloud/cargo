...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "hkdf-0_12_4-5fa923505668b238";
    meta.cargo_crate_info = {
      name = "hkdf";
      version = "0.12.4";
      crate_hash = "5fa923505668b238";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [hmac-0_12_1-bc3929f8e30dab3e];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=d39d603e61819c05 \
              -C extra-filename=-5fa923505668b238 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
