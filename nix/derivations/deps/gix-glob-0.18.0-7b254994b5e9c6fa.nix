...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-glob-0_18_0-7b254994b5e9c6fa";
    meta.cargo_crate_info = {
      name = "gix-glob";
      version = "0.18.0";
      crate_hash = "7b254994b5e9c6fa";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bitflags-2_8_0-d8308ebf07e22afd bstr-1_11_3-14003bcd5b7b8103 gix-features-0_40_0-7b4fa941d491da9c gix-path-0_10_14-6bb928c9998da5a8];
    passthru.rust_crate_parent = [];
    passthru.rust_script_build_run = [];
    phases = "unpackPhase buildPhase";

    src = pkgs.fetchurl {
      url = "https://crates.io/api/v1/crates/gix-glob/0.18.0/download";
    ...
    CARGO_CRATE_NAME = "gix_glob";
    CARGO_MANIFEST_DIR = "./";
    CARGO_MANIFEST_PATH = "./Cargo.toml";
    CARGO_PKG_AUTHORS = "Sebastian Thiel <sebastian.thiel@icloud.com>";
    CARGO_PKG_DESCRIPTION = "A crate of the gitoxide project dealing with pattern matching";
    CARGO_PKG_HOMEPAGE = "";
    CARGO_PKG_LICENSE = "MIT OR Apache-2.0";
    CARGO_PKG_LICENSE_FILE = "";
    CARGO_PKG_NAME = "gix-glob";
    CARGO_PKG_README = "";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-glob-0_18_0-7b254994b5e9c6fa"
      echo "@cargo { \"type\":0, \"crate_name\":\"gix-glob\", \"id\":\"gix-glob-0_18_0-7b254994b5e9c6fa\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=1c2b46394174f257 \
              -C extra-filename=-7b254994b5e9c6fa \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "gix-glob-0_18_0-7b254994b5e9c6fa" \
          --arg crate_name "gix-glob" \
