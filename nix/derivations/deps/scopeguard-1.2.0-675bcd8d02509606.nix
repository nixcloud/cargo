...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "scopeguard-1_2_0-675bcd8d02509606";
    meta.cargo_crate_info = {
      name = "scopeguard";
      version = "1.2.0";
      crate_hash = "675bcd8d02509606";
    };
...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m scopeguard-1_2_0-675bcd8d02509606"
      echo "@cargo { \"type\":0, \"crate_name\":\"scopeguard\", \"id\":\"scopeguard-1_2_0-675bcd8d02509606\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=eb643a9c8cd1d4ab \
              -C extra-filename=-675bcd8d02509606 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "scopeguard-1_2_0-675bcd8d02509606" \
          --arg crate_name "scopeguard" \
