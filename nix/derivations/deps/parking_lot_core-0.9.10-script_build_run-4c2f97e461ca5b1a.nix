...
{ pkgs, fn, cargo, rustc, deps, build_parser }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "parking_lot_core-0_9_10-script_build_run-4c2f97e461ca5b1a";
    meta.cargo_crate_info = {
      name = "parking_lot_core";
      version = "0.9.10";
      crate_hash = "4c2f97e461ca5b1a";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [];
    passthru.rust_crate_parent = [parking_lot_core-0_9_10-script_build-e99209837e9ad3b4];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m parking_lot_core-0_9_10-script_build_run-4c2f97e461ca5b1a"
      echo "@cargo { \"type\":0, \"crate_name\":\"parking_lot_core\", \"id\":\"parking_lot_core-0_9_10-script_build_run-4c2f97e461ca5b1a\" }"
      ...
      set -x +e
      ${ parking_lot_core-0_9_10-script_build-e99209837e9ad3b4 }/build_script_build > $OUT_DIR/nix/build_script_build.out 2> $build_script_build_output_lines
      ...
      if [ "$build_script_build_exit_value" -ne 0 ]; then
          output=$(${pkgs.jq}/bin/jq -c -n \
              ...
              --arg notice "There was an error executing build_script_build in file: '/home/nixos/cargo/target/debug/nix/derivations/deps/parking_lot_core-0.9.10-script_build_run-4c2f97e461ca5b1a.nix':" \
      ...
      if [ "$build_parser_exit_value" -ne 0 ]; then
          output=$(${pkgs.jq}/bin/jq -c -n \
              --arg crate_name "parking_lot_core" \
              --arg notice "There was an error executing build_parser in file: '/home/nixos/cargo/target/debug/nix/derivations/deps/parking_lot_core-0.9.10-script_build_run-4c2f97e461ca5b1a.nix':" \
      ...
      echo "@cargo {\"type\": 3, \"crate_name\": \"parking_lot_core\", \"exit_code\": 0, \"messages\": []}"
    '';
