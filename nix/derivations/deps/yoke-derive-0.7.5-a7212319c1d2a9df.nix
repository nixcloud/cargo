...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "yoke-derive-0_7_5-a7212319c1d2a9df";
    meta.cargo_crate_info = {
      name = "yoke-derive";
      version = "0.7.5";
      crate_hash = "a7212319c1d2a9df";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [proc-macro2-1_0_93-cfe81a59cf98819f quote-1_0_38-12b99e3192e30e82 syn-2_0_98-93aa0f13dad61a07 synstructure-0_13_1-b52c6310fdbcc413];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m yoke-derive-0_7_5-a7212319c1d2a9df"
      echo "@cargo { \"type\":0, \"crate_name\":\"yoke-derive\", \"id\":\"yoke-derive-0_7_5-a7212319c1d2a9df\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=119d73cc7b2fdb9a \
              -C extra-filename=-a7212319c1d2a9df \
              --out-dir $OUT_DIR \
              ...
              --extern synstructure=${synstructure-0_13_1-b52c6310fdbcc413}/libsynstructure-b52c6310fdbcc413.rlib \
              --extern proc_macro \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "yoke-derive-0_7_5-a7212319c1d2a9df" \
          --arg crate_name "yoke-derive" \
