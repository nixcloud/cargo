...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "hashbrown-0_14_5-5a3923327447427c";
    meta.cargo_crate_info = {
      name = "hashbrown";
      version = "0.14.5";
      crate_hash = "5a3923327447427c";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [ahash-0_8_11-d85bc5cef2391462 allocator-api2-0_2_21-fe10efef62e2f9d8];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=ab1f17dfded0e939 \
              -C extra-filename=-5a3923327447427c \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern ahash=${ahash-0_8_11-d85bc5cef2391462}/libahash-d85bc5cef2391462.rmeta \
              --extern allocator_api2=${allocator-api2-0_2_21-fe10efef62e2f9d8}/liballocator_api2-fe10efef62e2f9d8.rmeta \
