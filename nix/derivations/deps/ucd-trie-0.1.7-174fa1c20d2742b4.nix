...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m ucd-trie-0_1_7-174fa1c20d2742b4"
      echo "@cargo { \"type\":0, \"crate_name\":\"ucd-trie\", \"id\":\"ucd-trie-0_1_7-174fa1c20d2742b4\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "ucd-trie-0_1_7-174fa1c20d2742b4" \
          --arg crate_name "ucd-trie" \
