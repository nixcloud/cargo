...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "globset-0_4_15-c204f6852854b3a1";
    meta.cargo_crate_info = {
      name = "globset";
      version = "0.4.15";
      crate_hash = "c204f6852854b3a1";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [aho-corasick-1_1_3-511789a4780abe8b bstr-1_11_3-46100c463ffaaa37 log-0_4_25-fde7ab722b325b0e regex-automata-0_4_9-09b7fa440d2dfa3a regex-syntax-0_8_5-32c6de4fe11e3b8f];
...
simultaneously, and returning all of the globs that matched.";
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=02abb014d4ddd2a8 \
              -C extra-filename=-c204f6852854b3a1 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern aho_corasick=${aho-corasick-1_1_3-511789a4780abe8b}/libaho_corasick-511789a4780abe8b.rmeta \
              ...
              --extern regex_syntax=${regex-syntax-0_8_5-32c6de4fe11e3b8f}/libregex_syntax-32c6de4fe11e3b8f.rmeta \
