...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-path-0_10_14-fac4f7c597a0c8bd";
    meta.cargo_crate_info = {
      name = "gix-path";
      version = "0.10.14";
      crate_hash = "fac4f7c597a0c8bd";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [bstr-1_11_3-46100c463ffaaa37 gix-trace-0_1_12-718f68523d5ac749 home-0_5_11-918f819357cab881 once_cell-1_20_3-65600a49c06310f1 thiserror-2_0_11-c6c4ee382aacde15];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=7b48755c7514f9a3 \
              -C extra-filename=-fac4f7c597a0c8bd \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
