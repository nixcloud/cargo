...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "anyhow-1_0_96-61bbc4e08b05614c";
    meta.cargo_crate_info = {
      name = "anyhow";
      version = "1.0.96";
      crate_hash = "61bbc4e08b05614c";
      type = "";
    };
    ...
    passthru.rust_crate_parent = [anyhow-1_0_96-script_build_run-f080edeb228c5f3e];
    passthru.rust_script_build_run = [anyhow-1_0_96-script_build_run-f080edeb228c5f3e];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=b7845fed151a9ac0 \
              -C extra-filename=-61bbc4e08b05614c \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
