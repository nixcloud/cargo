...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "parking_lot_core-0_9_10-2bd58251de7bc904";
    meta.cargo_crate_info = {
      name = "parking_lot_core";
      version = "0.9.10";
      crate_hash = "2bd58251de7bc904";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [cfg-if-1_0_0-424abd49c6d5f017 libc-0_2_175-b265bb513a0388f3 smallvec-1_13_2-0ef9b24879be6fdc];
    passthru.rust_crate_parent = [parking_lot_core-0_9_10-script_build_run-323cca02bf1fcaa8];
    passthru.rust_script_build_run = [parking_lot_core-0_9_10-script_build_run-323cca02bf1fcaa8];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=78800d060ab7cd29 \
              -C extra-filename=-2bd58251de7bc904 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
