...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "deranged-0_3_11-091ab43039ab41fd";
    meta.cargo_crate_info = {
      name = "deranged";
      version = "0.3.11";
      crate_hash = "091ab43039ab41fd";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [powerfmt-0_2_0-85c859974cceb22a serde-1_0_218-ed8707ff8dc168e7];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=23478c18ab1b35a7 \
              -C extra-filename=-091ab43039ab41fd \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
