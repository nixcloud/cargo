...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "color-print-0_3_7-9618017c447b538d";
    meta.cargo_crate_info = {
      name = "color-print";
      version = "0.3.7";
      crate_hash = "9618017c447b538d";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [color-print-proc-macro-0_3_7-92102f3133fdb913];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=5ebd9cfb7d68c706 \
              -C extra-filename=-9618017c447b538d \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern color_print_proc_macro=${color-print-proc-macro-0_3_7-92102f3133fdb913}/libcolor_print_proc_macro-92102f3133fdb913.so \
