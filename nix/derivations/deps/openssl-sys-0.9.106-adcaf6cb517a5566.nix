...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m openssl-sys-0_9_106-adcaf6cb517a5566"
      echo "@cargo { \"type\":0, \"crate_name\":\"openssl-sys\", \"id\":\"openssl-sys-0_9_106-adcaf6cb517a5566\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "openssl-sys-0_9_106-adcaf6cb517a5566" \
