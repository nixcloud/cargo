...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "ecdsa-0_16_9-95753d738a0973a7";
    meta.cargo_crate_info = {
      name = "ecdsa";
      version = "0.16.9";
      crate_hash = "95753d738a0973a7";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [der-0_7_9-39bc94e6d7deac42 digest-0_10_7-d61413dd55c3b709 elliptic-curve-0_13_8-62624c894feb112b rfc6979-0_4_0-c30ead22cbafbf08 signature-2_2_0-bdcd5e167033dfda spki-0_7_3-71eafb32dcb1867a];
...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m ecdsa-0_16_9-95753d738a0973a7"
      echo "@cargo { \"type\":0, \"crate_name\":\"ecdsa\", \"id\":\"ecdsa-0_16_9-95753d738a0973a7\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=b3e122740767b436 \
              -C extra-filename=-95753d738a0973a7 \
              --out-dir $OUT_DIR \
              ...
              --extern rfc6979=${rfc6979-0_4_0-c30ead22cbafbf08}/librfc6979-c30ead22cbafbf08.rmeta \
              --extern signature=${signature-2_2_0-bdcd5e167033dfda}/libsignature-bdcd5e167033dfda.rmeta \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "ecdsa-0_16_9-95753d738a0973a7" \
          --arg crate_name "ecdsa" \
