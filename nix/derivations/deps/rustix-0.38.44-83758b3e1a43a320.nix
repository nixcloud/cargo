...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "rustix-0_38_44-83758b3e1a43a320";
    meta.cargo_crate_info = {
      name = "rustix";
      version = "0.38.44";
      crate_hash = "83758b3e1a43a320";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bitflags-2_8_0-d8308ebf07e22afd linux-raw-sys-0_4_15-624798d9199ea3b3];
    passthru.rust_crate_parent = [rustix-0_38_44-script_build_run-8ba6ad9cbdc9b810];
    passthru.rust_script_build_run = [rustix-0_38_44-script_build_run-8ba6ad9cbdc9b810];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m rustix-0_38_44-83758b3e1a43a320"
      echo "@cargo { \"type\":0, \"crate_name\":\"rustix\", \"id\":\"rustix-0_38_44-83758b3e1a43a320\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=d3c5984d3bebc8aa \
              -C extra-filename=-83758b3e1a43a320 \
              --out-dir $OUT_DIR \
              ${fn.rustc_linker_arguments passthru.rust_crate_libraries} \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              --extern bitflags=${bitflags-2_8_0-d8308ebf07e22afd}/libbitflags-d8308ebf07e22afd.rmeta \
              --extern linux_raw_sys=${linux-raw-sys-0_4_15-624798d9199ea3b3}/liblinux_raw_sys-624798d9199ea3b3.rmeta \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "rustix-0_38_44-83758b3e1a43a320" \
