...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "pin-project-lite-0_2_16-dbb7ad05ebc1034f";
    meta.cargo_crate_info = {
      name = "pin-project-lite";
      version = "0.2.16";
      crate_hash = "dbb7ad05ebc1034f";
    };
...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m pin-project-lite-0_2_16-dbb7ad05ebc1034f"
      echo "@cargo { \"type\":0, \"crate_name\":\"pin-project-lite\", \"id\":\"pin-project-lite-0_2_16-dbb7ad05ebc1034f\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=0bc07d59c2c97911 \
              -C extra-filename=-dbb7ad05ebc1034f \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "pin-project-lite-0_2_16-dbb7ad05ebc1034f" \
          --arg crate_name "pin-project-lite" \
