...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m regex-automata-0_4_9-5e0d341bfc5bf703"
      echo "@cargo { \"type\":0, \"crate_name\":\"regex-automata\", \"id\":\"regex-automata-0_4_9-5e0d341bfc5bf703\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "regex-automata-0_4_9-5e0d341bfc5bf703" \
