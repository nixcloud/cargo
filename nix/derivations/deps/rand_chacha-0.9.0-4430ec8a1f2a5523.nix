...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "rand_chacha-0_9_0-4430ec8a1f2a5523";
    meta.cargo_crate_info = {
      name = "rand_chacha";
      version = "0.9.0";
      crate_hash = "4430ec8a1f2a5523";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [ppv-lite86-0_2_20-42fae012c872c1dd rand_core-0_9_0-57170fd9c65611fe];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=e45bffceef1c38ad \
              -C extra-filename=-4430ec8a1f2a5523 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern ppv_lite86=${ppv-lite86-0_2_20-42fae012c872c1dd}/libppv_lite86-42fae012c872c1dd.rmeta \
