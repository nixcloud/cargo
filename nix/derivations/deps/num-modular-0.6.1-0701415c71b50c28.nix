...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "num-modular-0_6_1-0701415c71b50c28";
    meta.cargo_crate_info = {
      name = "num-modular";
      version = "0.6.1";
      crate_hash = "0701415c71b50c28";
    };
...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m num-modular-0_6_1-0701415c71b50c28"
      echo "@cargo { \"type\":0, \"crate_name\":\"num-modular\", \"id\":\"num-modular-0_6_1-0701415c71b50c28\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=0a7e6a44f2d8e67d \
              -C extra-filename=-0701415c71b50c28 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "num-modular-0_6_1-0701415c71b50c28" \
          --arg crate_name "num-modular" \
