...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "rand_core-0_9_0-57170fd9c65611fe";
    meta.cargo_crate_info = {
      name = "rand_core";
      version = "0.9.0";
      crate_hash = "57170fd9c65611fe";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [getrandom-0_3_1-e63b8caed24af524 zerocopy-0_8_17-04d0527ad86fa315];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=674a4a631ad5fa8f \
              -C extra-filename=-57170fd9c65611fe \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
