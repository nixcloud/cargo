...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "num-order-1_2_0-eff9366d228c9b94";
    meta.cargo_crate_info = {
      name = "num-order";
      version = "1.2.0";
      crate_hash = "eff9366d228c9b94";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [num-modular-0_6_1-e25974689701d542];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=6373c69705393aa2 \
              -C extra-filename=-eff9366d228c9b94 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern num_modular=${num-modular-0_6_1-e25974689701d542}/libnum_modular-e25974689701d542.rmeta \
