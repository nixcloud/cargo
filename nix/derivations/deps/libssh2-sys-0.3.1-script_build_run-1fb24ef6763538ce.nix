...
{ pkgs, fn, cargo, rustc, deps, build_parser }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "libssh2-sys-0_3_1-script_build_run-1fb24ef6763538ce";
    meta.cargo_crate_info = {
      name = "libssh2-sys";
      version = "0.3.1";
      crate_hash = "1fb24ef6763538ce";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [];
    passthru.rust_crate_parent = [libssh2-sys-0_3_1-script_build-ca72618460c8858e];
    passthru.rust_script_build_run = [libz-sys-1_1_21-69f52d4cc5a20a24 openssl-sys-0_9_106-adcaf6cb517a5566];
    phases = "";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m libssh2-sys-0_3_1-script_build_run-1fb24ef6763538ce"
      echo "@cargo { \"type\":0, \"crate_name\":\"libssh2-sys\", \"id\":\"libssh2-sys-0_3_1-script_build_run-1fb24ef6763538ce\" }"
      ...
      set -x +e
      ${ libssh2-sys-0_3_1-script_build-ca72618460c8858e }/build_script_build > $OUT_DIR/nix/build_script_build.out 2> $build_script_build_output_lines
      ...
      if [ "$build_script_build_exit_value" -ne 0 ]; then
          output=$(${pkgs.jq}/bin/jq -c -n \
              ...
              --arg notice "There was an error executing build_script_build in file: '/home/nixos/cargo/target/debug/nix/derivations/deps/libssh2-sys-0.3.1-script_build_run-1fb24ef6763538ce.nix':" \
      ...
      if [ "$build_parser_exit_value" -ne 0 ]; then
          output=$(${pkgs.jq}/bin/jq -c -n \
              --arg crate_name "libssh2-sys" \
              --arg notice "There was an error executing build_parser in file: '/home/nixos/cargo/target/debug/nix/derivations/deps/libssh2-sys-0.3.1-script_build_run-1fb24ef6763538ce.nix':" \
      ...
      echo "@cargo {\"type\": 3, \"crate_name\": \"libssh2-sys\", \"exit_code\": 0, \"messages\": []}"
    '';
