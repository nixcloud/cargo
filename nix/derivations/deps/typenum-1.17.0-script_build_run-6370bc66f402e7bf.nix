...
{ pkgs, fn, cargo, rustc, deps, build_parser }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m typenum-1_17_0-script_build_run-6370bc66f402e7bf"
      echo "@cargo { \"type\":0, \"crate_name\":\"typenum\", \"id\":\"typenum-1_17_0-script_build_run-6370bc66f402e7bf\" }"
      ...
      if [ "$build_script_build_exit_value" -ne 0 ]; then
          output=$(${pkgs.jq}/bin/jq -c -n \
              ...
              --arg notice "There was an error executing build_script_build in file: '/home/nixos/cargo/target/debug/nix/derivations/deps/typenum-1.17.0-script_build_run-6370bc66f402e7bf.nix':" \
      ...
      if [ "$build_parser_exit_value" -ne 0 ]; then
          output=$(${pkgs.jq}/bin/jq -c -n \
              --arg crate_name "typenum" \
              --arg notice "There was an error executing build_parser in file: '/home/nixos/cargo/target/debug/nix/derivations/deps/typenum-1.17.0-script_build_run-6370bc66f402e7bf.nix':" \
      ...
      echo "@cargo {\"type\": 3, \"crate_name\": \"typenum\", \"exit_code\": 0, \"messages\": []}"
    '';
