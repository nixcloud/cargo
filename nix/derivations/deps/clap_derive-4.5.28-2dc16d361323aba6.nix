...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "clap_derive-4_5_28-2dc16d361323aba6";
    meta.cargo_crate_info = {
      name = "clap_derive";
      version = "4.5.28";
      crate_hash = "2dc16d361323aba6";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [heck-0_5_0-7cca0b380f9fed60 proc-macro2-1_0_93-8972bce74b99a2b8 quote-1_0_38-69fc837ab5040c10 syn-2_0_98-cf14ab7ccae9dbe8];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=67b37f8129f1ff4f \
              -C extra-filename=-2dc16d361323aba6 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern heck=${heck-0_5_0-7cca0b380f9fed60}/libheck-7cca0b380f9fed60.rlib \
