...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-ref-0_50_0-9c43a6c2d25dc4c1";
    meta.cargo_crate_info = {
      name = "gix-ref";
      version = "0.50.0";
      crate_hash = "9c43a6c2d25dc4c1";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [gix-actor-0_33_2-6f4ab7bcb15a2392 gix-features-0_40_0-7b4fa941d491da9c gix-fs-0_13_0-32f209ecf862a862 gix-hash-0_16_0-2dd06b7faad8300b gix-lock-16_0_0-c0e4d3d42bd1d641 gix-object-0_47_0-1feb494be43bf821 gix-path-0_10_14-6bb928c9998da5a8 gix-tempfile-16_0_0-83660278b0f5c0f2 gix-utils-0_1_14-4da59f2b8afebe0a gix-validate-0_9_3-5cd523d9060c9684 memmap2-0_9_5-74a37f7611502dc0 thiserror-2_0_11-a57592ffa4ea41e0 winnow-0_6_26-83cf2fecf0abf70e];
    passthru.rust_crate_parent = [];
    passthru.rust_script_build_run = [];
    phases = "unpackPhase buildPhase";

    src = pkgs.fetchurl {
      url = "https://crates.io/api/v1/crates/gix-ref/0.50.0/download";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-ref-0_50_0-9c43a6c2d25dc4c1"
      echo "@cargo { \"type\":0, \"crate_name\":\"gix-ref\", \"id\":\"gix-ref-0_50_0-9c43a6c2d25dc4c1\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=4cd893c5f2e2ba16 \
              -C extra-filename=-9c43a6c2d25dc4c1 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "gix-ref-0_50_0-9c43a6c2d25dc4c1" \
          --arg crate_name "gix-ref" \
