...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "curl-sys-0_4_80_plus_curl-8_12_1-e26ceb4086d88aa5";
    meta.cargo_crate_info = {
      name = "curl-sys";
      version = "0.4.80+curl-8.12.1";
      crate_hash = "e26ceb4086d88aa5";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [libc-0_2_175-b265bb513a0388f3 libnghttp2-sys-0_1_11_plus_1_64_0-fc24622a308fad5a libz-sys-1_1_21-8eb7d635fee6f8cb openssl-sys-0_9_106-fe430717cd107543];
    passthru.rust_crate_parent = [curl-sys-0_4_80_plus_curl-8_12_1-script_build_run-3b4d64c654555321];
    passthru.rust_script_build_run = [curl-sys-0_4_80_plus_curl-8_12_1-script_build_run-3b4d64c654555321];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=6915ff9d492ff41e \
              -C extra-filename=-e26ceb4086d88aa5 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              ...
              --extern libnghttp2_sys=${libnghttp2-sys-0_1_11_plus_1_64_0-fc24622a308fad5a}/liblibnghttp2_sys-fc24622a308fad5a.rmeta \
