...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-shallow-0_2_0-17cceba6b74ec6c7";
    meta.cargo_crate_info = {
      name = "gix-shallow";
      version = "0.2.0";
      crate_hash = "17cceba6b74ec6c7";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bstr-1_11_3-14003bcd5b7b8103 gix-hash-0_16_0-2dd06b7faad8300b gix-lock-16_0_0-c0e4d3d42bd1d641 thiserror-2_0_11-a57592ffa4ea41e0];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-shallow-0_2_0-17cceba6b74ec6c7"
      echo "@cargo { \"type\":0, \"crate_name\":\"gix-shallow\", \"id\":\"gix-shallow-0_2_0-17cceba6b74ec6c7\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=24e30af907c2a406 \
              -C extra-filename=-17cceba6b74ec6c7 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "gix-shallow-0_2_0-17cceba6b74ec6c7" \
          --arg crate_name "gix-shallow" \
