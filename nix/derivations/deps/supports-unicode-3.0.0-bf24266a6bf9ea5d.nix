...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "supports-unicode-3_0_0-bf24266a6bf9ea5d";
    meta.cargo_crate_info = {
      name = "supports-unicode";
      version = "3.0.0";
      crate_hash = "bf24266a6bf9ea5d";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m supports-unicode-3_0_0-bf24266a6bf9ea5d"
      echo "@cargo { \"type\":0, \"crate_name\":\"supports-unicode\", \"id\":\"supports-unicode-3_0_0-bf24266a6bf9ea5d\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=d163d9a8e8995181 \
              -C extra-filename=-bf24266a6bf9ea5d \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "supports-unicode-3_0_0-bf24266a6bf9ea5d" \
          --arg crate_name "supports-unicode" \
