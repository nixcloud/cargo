...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m idna_adapter-1_2_0-912ba833bfc7b013"
      echo "@cargo { \"type\":0, \"crate_name\":\"idna_adapter\", \"id\":\"idna_adapter-1_2_0-912ba833bfc7b013\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "idna_adapter-1_2_0-912ba833bfc7b013" \
          --arg crate_name "idna_adapter" \
