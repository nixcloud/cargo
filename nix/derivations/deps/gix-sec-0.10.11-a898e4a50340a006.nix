...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-sec-0_10_11-a898e4a50340a006";
    meta.cargo_crate_info = {
      name = "gix-sec";
      version = "0.10.11";
      crate_hash = "a898e4a50340a006";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bitflags-2_8_0-d8308ebf07e22afd libc-0_2_175-df0687d6868fdede];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-sec-0_10_11-a898e4a50340a006"
      echo "@cargo { \"type\":0, \"crate_name\":\"gix-sec\", \"id\":\"gix-sec-0_10_11-a898e4a50340a006\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=64fdfe287ef14645 \
              -C extra-filename=-a898e4a50340a006 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "gix-sec-0_10_11-a898e4a50340a006" \
          --arg crate_name "gix-sec" \
