...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-config-value-0_14_11-75309d14f49a1fbd";
    meta.cargo_crate_info = {
      name = "gix-config-value";
      version = "0.14.11";
      crate_hash = "75309d14f49a1fbd";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [bitflags-2_8_0-25bacb8b683e4264 bstr-1_11_3-46100c463ffaaa37 gix-path-0_10_14-fac4f7c597a0c8bd libc-0_2_175-b265bb513a0388f3 thiserror-2_0_11-c6c4ee382aacde15];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=e8b4d1482612b533 \
              -C extra-filename=-75309d14f49a1fbd \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
