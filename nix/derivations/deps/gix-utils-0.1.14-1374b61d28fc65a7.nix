...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-utils-0_1_14-1374b61d28fc65a7";
    meta.cargo_crate_info = {
      name = "gix-utils";
      version = "0.1.14";
      crate_hash = "1374b61d28fc65a7";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [bstr-1_11_3-46100c463ffaaa37 fastrand-2_3_0-a6e21b8cf3724d00 unicode-normalization-0_1_24-64cc5e0be95aacea];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=b270a633cccaedc9 \
              -C extra-filename=-1374b61d28fc65a7 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              ...
              --extern unicode_normalization=${unicode-normalization-0_1_24-64cc5e0be95aacea}/libunicode_normalization-64cc5e0be95aacea.rmeta \
