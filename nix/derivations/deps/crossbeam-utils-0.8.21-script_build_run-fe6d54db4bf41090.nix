...
{ pkgs, fn, cargo, rustc, deps, build_parser }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "crossbeam-utils-0_8_21-script_build_run-fe6d54db4bf41090";
    meta.cargo_crate_info = {
      name = "crossbeam-utils";
      version = "0.8.21";
      crate_hash = "fe6d54db4bf41090";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [];
    passthru.rust_crate_parent = [crossbeam-utils-0_8_21-script_build-12f6a43a9fc01710];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m crossbeam-utils-0_8_21-script_build_run-fe6d54db4bf41090"
      echo "@cargo { \"type\":0, \"crate_name\":\"crossbeam-utils\", \"id\":\"crossbeam-utils-0_8_21-script_build_run-fe6d54db4bf41090\" }"
      ...
      set -x +e
      ${ crossbeam-utils-0_8_21-script_build-12f6a43a9fc01710 }/build_script_build > $OUT_DIR/nix/build_script_build.out 2> $build_script_build_output_lines
      ...
      if [ "$build_script_build_exit_value" -ne 0 ]; then
          output=$(${pkgs.jq}/bin/jq -c -n \
              ...
              --arg notice "There was an error executing build_script_build in file: '/home/nixos/cargo/target/debug/nix/derivations/deps/crossbeam-utils-0.8.21-script_build_run-fe6d54db4bf41090.nix':" \
      ...
      if [ "$build_parser_exit_value" -ne 0 ]; then
          output=$(${pkgs.jq}/bin/jq -c -n \
              --arg crate_name "crossbeam-utils" \
              --arg notice "There was an error executing build_parser in file: '/home/nixos/cargo/target/debug/nix/derivations/deps/crossbeam-utils-0.8.21-script_build_run-fe6d54db4bf41090.nix':" \
      ...
      echo "@cargo {\"type\": 3, \"crate_name\": \"crossbeam-utils\", \"exit_code\": 0, \"messages\": []}"
    '';
