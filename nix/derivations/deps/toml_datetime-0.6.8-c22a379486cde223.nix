...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m toml_datetime-0_6_8-c22a379486cde223"
      echo "@cargo { \"type\":0, \"crate_name\":\"toml_datetime\", \"id\":\"toml_datetime-0_6_8-c22a379486cde223\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "toml_datetime-0_6_8-c22a379486cde223" \
          --arg crate_name "toml_datetime" \
