...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "is_executable-1_0_4-cbdb08034b5ed4b3";
    meta.cargo_crate_info = {
      name = "is_executable";
      version = "1.0.4";
      crate_hash = "cbdb08034b5ed4b3";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m is_executable-1_0_4-cbdb08034b5ed4b3"
      echo "@cargo { \"type\":0, \"crate_name\":\"is_executable\", \"id\":\"is_executable-1_0_4-cbdb08034b5ed4b3\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=e81cc6e9aadd45b8 \
              -C extra-filename=-cbdb08034b5ed4b3 \
              --out-dir $OUT_DIR \
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "is_executable-1_0_4-cbdb08034b5ed4b3" \
          --arg crate_name "is_executable" \
