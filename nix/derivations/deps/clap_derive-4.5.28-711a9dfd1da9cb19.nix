...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m clap_derive-4_5_28-711a9dfd1da9cb19"
      echo "@cargo { \"type\":0, \"crate_name\":\"clap_derive\", \"id\":\"clap_derive-4_5_28-711a9dfd1da9cb19\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "clap_derive-4_5_28-711a9dfd1da9cb19" \
          --arg crate_name "clap_derive" \
