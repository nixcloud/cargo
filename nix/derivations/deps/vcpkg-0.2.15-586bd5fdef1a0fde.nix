...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m vcpkg-0_2_15-586bd5fdef1a0fde"
      echo "@cargo { \"type\":0, \"crate_name\":\"vcpkg\", \"id\":\"vcpkg-0_2_15-586bd5fdef1a0fde\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "vcpkg-0_2_15-586bd5fdef1a0fde" \
          --arg crate_name "vcpkg" \
