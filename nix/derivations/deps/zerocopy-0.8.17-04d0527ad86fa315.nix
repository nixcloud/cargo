...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "zerocopy-0_8_17-04d0527ad86fa315";
    meta.cargo_crate_info = {
      name = "zerocopy";
      version = "0.8.17";
      crate_hash = "04d0527ad86fa315";
      type = "";
    };
    ...
    passthru.rust_crate_parent = [zerocopy-0_8_17-script_build_run-e58836af3abc2c45];
    passthru.rust_script_build_run = [zerocopy-0_8_17-script_build_run-e58836af3abc2c45];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=927894d366756a6d \
              -C extra-filename=-04d0527ad86fa315 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
