...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "lock_api-0_4_12-88e61f41ab242739";
    meta.cargo_crate_info = {
      name = "lock_api";
      version = "0.4.12";
      crate_hash = "88e61f41ab242739";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [scopeguard-1_2_0-81ac818d244aecf5];
    passthru.rust_crate_parent = [lock_api-0_4_12-script_build_run-e5bf3553f6529fb8];
    passthru.rust_script_build_run = [lock_api-0_4_12-script_build_run-e5bf3553f6529fb8];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=dd05646d25584c51 \
              -C extra-filename=-88e61f41ab242739 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern scopeguard=${scopeguard-1_2_0-81ac818d244aecf5}/libscopeguard-81ac818d244aecf5.rmeta \
