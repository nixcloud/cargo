...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "flate2-1_1_0-f05ad64f5d566c20";
    meta.cargo_crate_info = {
      name = "flate2";
      version = "1.1.0";
      crate_hash = "f05ad64f5d566c20";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [crc32fast-1_4_2-6198ec617f8ea4ed libz-sys-1_1_21-8eb7d635fee6f8cb miniz_oxide-0_8_5-dd96155c9162e8a2];
...
and raw deflate streams.";
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=d5e18b040a1c3383 \
              -C extra-filename=-f05ad64f5d566c20 \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              ...
              --extern miniz_oxide=${miniz_oxide-0_8_5-dd96155c9162e8a2}/libminiz_oxide-dd96155c9162e8a2.rmeta \
