...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "libgit2-sys-0_18_0_plus_1_9_0-script_build-df53d2b5ce2efa6a";
    meta.cargo_crate_info = {
      name = "libgit2-sys";
      version = "0.18.0+1.9.0";
      crate_hash = "df53d2b5ce2efa6a";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m libgit2-sys-0_18_0_plus_1_9_0-script_build-df53d2b5ce2efa6a"
      echo "@cargo { \"type\":0, \"crate_name\":\"libgit2-sys\", \"id\":\"libgit2-sys-0_18_0_plus_1_9_0-script_build-df53d2b5ce2efa6a\" }"
      ...
      ${RUSTC} \
              ...
              -C metadata=97792ff5ca54694f \
              -C extra-filename=-df53d2b5ce2efa6a \
              --out-dir $OUT_DIR \
      ...
      do
          ...
          ${pkgs.jq}/bin/jq -r -c 'select(."$message_type"=="diagnostic") | .rendered' $tmpFile
            ...
            ln -s $OUT_DIR/"$CARGO_CRATE_NAME"-df53d2b5ce2efa6a $OUT_DIR/build_script_build
      
      # return structured formatted errors for later processing
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "libgit2-sys-0_18_0_plus_1_9_0-script_build-df53d2b5ce2efa6a" \
