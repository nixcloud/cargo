...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m ignore-0_4_23-dab7af6f0867647c"
      echo "@cargo { \"type\":0, \"crate_name\":\"ignore\", \"id\":\"ignore-0_4_23-dab7af6f0867647c\" }"
      ...
      output=$(${pkgs.jq}/bin/jq -s -r -c \
          --arg fullname "ignore-0_4_23-dab7af6f0867647c" \
          --arg crate_name "ignore" \
