...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "git2-curl-0_21_0-aa8fb836bc90345d";
    meta.cargo_crate_info = {
      name = "git2-curl";
      version = "0.21.0";
      crate_hash = "aa8fb836bc90345d";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [curl-0_4_47-8a5016373deb916e git2-0_20_0-50735b59c53beae1 log-0_4_25-fde7ab722b325b0e url-2_5_4-659fce6bf9b29cb7];
...
Intended to be used with the git2 crate.";
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=bb8d0b29195ceeb4 \
              -C extra-filename=-aa8fb836bc90345d \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
