...
{ fn, pkgs, rustc, cargo, deps, project_root }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "derive_builder_macro-0_20_2-202d4187b36add0b";
    meta.cargo_crate_info = {
      name = "derive_builder_macro";
      version = "0.20.2";
      crate_hash = "202d4187b36add0b";
      type = "";
    };
    buildInputs = [] ++ fn.inject_deps meta.cargo_crate_info;
    env = fn.inject_envs meta.cargo_crate_info;

    passthru.rust_crate_libraries = [derive_builder_core-0_20_2-776491bd3cff748b syn-2_0_98-cf14ab7ccae9dbe8];
    ...
    buildPhase = ''
      ...
      ${RUSTC} \
              ...
              -C metadata=3fadf1ff3b6575c5 \
              -C extra-filename=-202d4187b36add0b \
              --out-dir $OUT_DIR \
              -C strip=debuginfo \
              -L dependency=${fn.rustc_linker_arguments_dir passthru.rust_crate_libraries}/deps \
              ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
              ${fn.rustc_propagated_arguments passthru.rust_crate_libraries} \
              --extern derive_builder_core=${derive_builder_core-0_20_2-776491bd3cff748b}/libderive_builder_core-776491bd3cff748b.rlib \
