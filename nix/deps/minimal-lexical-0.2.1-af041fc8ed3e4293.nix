...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "minimal-lexical-0_2_1-af041fc8ed3e4293";
    meta.cargo_crate_info = {
      name = "minimal-lexical";
      version = "0.2.1";
      crate_hash = "af041fc8ed3e4293";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m minimal-lexical-0_2_1-af041fc8ed3e4293"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=371f0d69d6a18f74 \
        -C extra-filename=-af041fc8ed3e4293 \
        --out-dir $OUT_DIR \
