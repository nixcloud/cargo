...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "stable_deref_trait-1_2_0-567eccf8a716e5cb";
    meta.cargo_crate_info = {
      name = "stable_deref_trait";
      version = "1.2.0";
      crate_hash = "567eccf8a716e5cb";
    };
...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m stable_deref_trait-1_2_0-567eccf8a716e5cb"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=8d9d36a133b5a1b7 \
        -C extra-filename=-567eccf8a716e5cb \
        --out-dir $OUT_DIR \
