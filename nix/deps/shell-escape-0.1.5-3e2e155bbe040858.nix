...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "shell-escape-0_1_5-3e2e155bbe040858";
    meta.cargo_crate_info = {
      name = "shell-escape";
      version = "0.1.5";
      crate_hash = "3e2e155bbe040858";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m shell-escape-0_1_5-3e2e155bbe040858"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=f2ed96655a61a69f \
        -C extra-filename=-3e2e155bbe040858 \
        --out-dir $OUT_DIR \
