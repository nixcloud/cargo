...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "colorchoice-1_0_3-ba17308800d88ed6";
    meta.cargo_crate_info = {
      name = "colorchoice";
      version = "1.0.3";
      crate_hash = "ba17308800d88ed6";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m colorchoice-1_0_3-ba17308800d88ed6"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=664717931b6ad53b \
        -C extra-filename=-ba17308800d88ed6 \
        --out-dir $OUT_DIR \
