...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "icu_properties_data-1_5_0-2325023fb5c18f26";
    meta.cargo_crate_info = {
      name = "icu_properties_data";
      version = "1.5.0";
      crate_hash = "2325023fb5c18f26";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m icu_properties_data-1_5_0-2325023fb5c18f26"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=970cf81cae735087 \
        -C extra-filename=-2325023fb5c18f26 \
        --out-dir $OUT_DIR \
