...
{ fn, pkgs, rustc, cargo, deps, build_parser }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "ahash-0_8_11-script_build_run-76dc9e72e06fbb60";
    meta.cargo_crate_info = {
      name = "ahash";
      version = "0.8.11";
      crate_hash = "76dc9e72e06fbb60";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [];
    passthru.rust_crate_parent = [ahash-0_8_11-script_build-49923e8374b98165];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m ahash-0_8_11-script_build_run-76dc9e72e06fbb60"
      ...
      (set -x 
      ${ahash-0_8_11-script_build-49923e8374b98165}/build_script_build > $OUT_DIR/nix/build_script_build.out
