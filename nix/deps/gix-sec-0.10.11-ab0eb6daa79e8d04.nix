...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-sec-0_10_11-ab0eb6daa79e8d04";
    meta.cargo_crate_info = {
      name = "gix-sec";
      version = "0.10.11";
      crate_hash = "ab0eb6daa79e8d04";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bitflags-2_8_0-27b6a5758605f436 libc-0_2_170-d46a143b0470970d];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-sec-0_10_11-ab0eb6daa79e8d04"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=c75ff69b78f87f8f \
        -C extra-filename=-ab0eb6daa79e8d04 \
        --out-dir $OUT_DIR \
