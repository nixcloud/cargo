...
{ fn, pkgs, rustc, cargo, deps, build_parser }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "anyhow-1_0_96-script_build_run-dd5e8039e5640bda";
    meta.cargo_crate_info = {
      name = "anyhow";
      version = "1.0.96";
      crate_hash = "dd5e8039e5640bda";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [];
    passthru.rust_crate_parent = [anyhow-1_0_96-script_build-da4fcc81118fb24c];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m anyhow-1_0_96-script_build_run-dd5e8039e5640bda"
      ...
      (set -x 
      ${anyhow-1_0_96-script_build-da4fcc81118fb24c}/build_script_build > $OUT_DIR/nix/build_script_build.out
