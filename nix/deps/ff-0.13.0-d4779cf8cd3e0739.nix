...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "ff-0_13_0-d4779cf8cd3e0739";
    meta.cargo_crate_info = {
      name = "ff";
      version = "0.13.0";
      crate_hash = "d4779cf8cd3e0739";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [rand_core-0_6_4-fe99bd26a150a053 subtle-2_6_1-0482376bbaa3bb74];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m ff-0_13_0-d4779cf8cd3e0739"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=147ad684906ec022 \
        -C extra-filename=-d4779cf8cd3e0739 \
        --out-dir $OUT_DIR \
