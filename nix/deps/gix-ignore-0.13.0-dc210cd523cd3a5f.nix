...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-ignore-0_13_0-dc210cd523cd3a5f";
    meta.cargo_crate_info = {
      name = "gix-ignore";
      version = "0.13.0";
      crate_hash = "dc210cd523cd3a5f";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bstr-1_11_3-29be561fe10b8eeb gix-glob-0_18_0-0d0d6365a30d9fb0 gix-path-0_10_14-2414f38f73019524 gix-trace-0_1_12-e7c79603b3e36d61 unicode-bom-2_0_3-791ebb1e77c846a2];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-ignore-0_13_0-dc210cd523cd3a5f"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=81b686b3f7163dbe \
        -C extra-filename=-dc210cd523cd3a5f \
        --out-dir $OUT_DIR \
