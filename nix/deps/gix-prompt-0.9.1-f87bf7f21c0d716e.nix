...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-prompt-0_9_1-f87bf7f21c0d716e";
    meta.cargo_crate_info = {
      name = "gix-prompt";
      version = "0.9.1";
      crate_hash = "f87bf7f21c0d716e";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [gix-command-0_4_1-d7db7f609223402c gix-config-value-0_14_11-754c200bd99eaf58 parking_lot-0_12_3-ff08a1b844db7fce rustix-0_38_44-c73c53514f7b96d9 thiserror-2_0_11-266d93aab4cee78a];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-prompt-0_9_1-f87bf7f21c0d716e"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=f24f88bfc240ecc6 \
        -C extra-filename=-f87bf7f21c0d716e \
        --out-dir $OUT_DIR \
