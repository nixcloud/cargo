...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-fs-0_13_0-255b0b7de5a5da06";
    meta.cargo_crate_info = {
      name = "gix-fs";
      version = "0.13.0";
      crate_hash = "255b0b7de5a5da06";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [fastrand-2_3_0-f3010612e1a3785f gix-features-0_40_0-28fa590012f22da9 gix-utils-0_1_14-286091b3d3e35677];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-fs-0_13_0-255b0b7de5a5da06"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=1de040efaa9dd574 \
        -C extra-filename=-255b0b7de5a5da06 \
        --out-dir $OUT_DIR \
