...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "openssl-sys-0_9_106-script_build-619033989f31f468";
    meta.cargo_crate_info = {
      name = "openssl-sys";
      version = "0.9.106";
      crate_hash = "619033989f31f468";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m openssl-sys-0_9_106-script_build-619033989f31f468"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=88fe6a416183b668 \
        -C extra-filename=-619033989f31f468 \
        --out-dir $OUT_DIR \
        ...
        --cap-lints allow
      ln -s $OUT_DIR/"$CARGO_CRATE_NAME"-619033989f31f468 $OUT_DIR/build_script_build
      )
    '';
}
