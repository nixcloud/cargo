...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "toml_datetime-0_6_8-a3c5cf9ae48cc981";
    meta.cargo_crate_info = {
      name = "toml_datetime";
      version = "0.6.8";
      crate_hash = "a3c5cf9ae48cc981";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m toml_datetime-0_6_8-a3c5cf9ae48cc981"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=66e90cd8afdf66e2 \
        -C extra-filename=-a3c5cf9ae48cc981 \
        --out-dir $OUT_DIR \
