...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "linux-raw-sys-0_4_15-4a0c260c6dd78b8e";
    meta.cargo_crate_info = {
      name = "linux-raw-sys";
      version = "0.4.15";
      crate_hash = "4a0c260c6dd78b8e";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m linux-raw-sys-0_4_15-4a0c260c6dd78b8e"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=9c514044fe8374cb \
        -C extra-filename=-4a0c260c6dd78b8e \
        --out-dir $OUT_DIR \
