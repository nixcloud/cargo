...
{ fn, pkgs, rustc, cargo, deps, build_parser }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "serde_json-1_0_139-script_build_run-61a343ceda772c28";
    meta.cargo_crate_info = {
      name = "serde_json";
      version = "1.0.139";
      crate_hash = "61a343ceda772c28";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [];
    passthru.rust_crate_parent = [serde_json-1_0_139-script_build-f5c2f2eb2c6a8b1c];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m serde_json-1_0_139-script_build_run-61a343ceda772c28"
      ...
      (set -x 
      ${serde_json-1_0_139-script_build-f5c2f2eb2c6a8b1c}/build_script_build > $OUT_DIR/nix/build_script_build.out
