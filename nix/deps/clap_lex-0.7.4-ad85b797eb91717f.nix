...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "clap_lex-0_7_4-ad85b797eb91717f";
    meta.cargo_crate_info = {
      name = "clap_lex";
      version = "0.7.4";
      crate_hash = "ad85b797eb91717f";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m clap_lex-0_7_4-ad85b797eb91717f"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=5088c99ddec55a28 \
        -C extra-filename=-ad85b797eb91717f \
        --out-dir $OUT_DIR \
