...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-config-value-0_14_11-754c200bd99eaf58";
    meta.cargo_crate_info = {
      name = "gix-config-value";
      version = "0.14.11";
      crate_hash = "754c200bd99eaf58";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bitflags-2_8_0-27b6a5758605f436 bstr-1_11_3-29be561fe10b8eeb gix-path-0_10_14-2414f38f73019524 libc-0_2_170-d46a143b0470970d thiserror-2_0_11-266d93aab4cee78a];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-config-value-0_14_11-754c200bd99eaf58"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=2df5bc68ad208b9e \
        -C extra-filename=-754c200bd99eaf58 \
        --out-dir $OUT_DIR \
