...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-attributes-0_24_0-839dd8a3503d8e44";
    meta.cargo_crate_info = {
      name = "gix-attributes";
      version = "0.24.0";
      crate_hash = "839dd8a3503d8e44";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bstr-1_11_3-29be561fe10b8eeb gix-glob-0_18_0-0d0d6365a30d9fb0 gix-path-0_10_14-2414f38f73019524 gix-quote-0_4_15-052d0b90d2515f5d gix-trace-0_1_12-e7c79603b3e36d61 kstring-2_0_2-1b0752db97618130 smallvec-1_13_2-453c588ad74a5894 thiserror-2_0_11-266d93aab4cee78a unicode-bom-2_0_3-791ebb1e77c846a2];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-attributes-0_24_0-839dd8a3503d8e44"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=ee8425fa480adaff \
        -C extra-filename=-839dd8a3503d8e44 \
        --out-dir $OUT_DIR \
        ...
        --extern kstring=${kstring-2_0_2-1b0752db97618130}/libkstring-1b0752db97618130.rmeta \
