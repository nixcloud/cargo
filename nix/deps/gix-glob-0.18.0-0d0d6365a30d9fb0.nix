...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-glob-0_18_0-0d0d6365a30d9fb0";
    meta.cargo_crate_info = {
      name = "gix-glob";
      version = "0.18.0";
      crate_hash = "0d0d6365a30d9fb0";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bitflags-2_8_0-27b6a5758605f436 bstr-1_11_3-29be561fe10b8eeb gix-features-0_40_0-28fa590012f22da9 gix-path-0_10_14-2414f38f73019524];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-glob-0_18_0-0d0d6365a30d9fb0"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=b5352c410c506a03 \
        -C extra-filename=-0d0d6365a30d9fb0 \
        --out-dir $OUT_DIR \
