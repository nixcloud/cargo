...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "scopeguard-1_2_0-9ef05b539fdc0340";
    meta.cargo_crate_info = {
      name = "scopeguard";
      version = "1.2.0";
      crate_hash = "9ef05b539fdc0340";
    };
...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m scopeguard-1_2_0-9ef05b539fdc0340"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=46fceca5537cb02b \
        -C extra-filename=-9ef05b539fdc0340 \
        --out-dir $OUT_DIR \
