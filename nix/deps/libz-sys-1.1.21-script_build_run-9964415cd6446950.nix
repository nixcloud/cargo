...
{ fn, pkgs, rustc, cargo, deps, build_parser }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "libz-sys-1_1_21-script_build_run-9964415cd6446950";
    meta.cargo_crate_info = {
      name = "libz-sys";
      version = "1.1.21";
      crate_hash = "9964415cd6446950";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [];
    passthru.rust_crate_parent = [libz-sys-1_1_21-script_build-4f374c1ca3820d67];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m libz-sys-1_1_21-script_build_run-9964415cd6446950"
      ...
      (set -x 
      ${libz-sys-1_1_21-script_build-4f374c1ca3820d67}/build_script_build > $OUT_DIR/nix/build_script_build.out
