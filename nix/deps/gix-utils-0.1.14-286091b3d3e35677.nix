...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-utils-0_1_14-286091b3d3e35677";
    meta.cargo_crate_info = {
      name = "gix-utils";
      version = "0.1.14";
      crate_hash = "286091b3d3e35677";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bstr-1_11_3-29be561fe10b8eeb fastrand-2_3_0-f3010612e1a3785f unicode-normalization-0_1_24-44075d834d14633a];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-utils-0_1_14-286091b3d3e35677"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=c3e8382d2df3dcf4 \
        -C extra-filename=-286091b3d3e35677 \
        --out-dir $OUT_DIR \
        ...
        --extern unicode_normalization=${unicode-normalization-0_1_24-44075d834d14633a}/libunicode_normalization-44075d834d14633a.rmeta \
        --cap-lints allow
      )
    '';
}
