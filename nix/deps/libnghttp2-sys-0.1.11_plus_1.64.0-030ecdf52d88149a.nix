...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "libnghttp2-sys-0_1_11_plus_1_64_0-030ecdf52d88149a";
    meta.cargo_crate_info = {
      name = "libnghttp2-sys";
      version = "0.1.11+1.64.0";
      crate_hash = "030ecdf52d88149a";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [libc-0_2_170-d46a143b0470970d];
    passthru.rust_crate_parent = [libnghttp2-sys-0_1_11_plus_1_64_0-script_build_run-a7a473a2bc3c4265];
    passthru.rust_script_build_run = [libnghttp2-sys-0_1_11_plus_1_64_0-script_build_run-a7a473a2bc3c4265];
...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m libnghttp2-sys-0_1_11_plus_1_64_0-030ecdf52d88149a"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=c1b3b5d8c76922ca \
        -C extra-filename=-030ecdf52d88149a \
        --out-dir $OUT_DIR \
