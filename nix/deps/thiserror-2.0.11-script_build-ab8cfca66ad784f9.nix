...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "thiserror-2_0_11-script_build-ab8cfca66ad784f9";
    meta.cargo_crate_info = {
      name = "thiserror";
      version = "2.0.11";
      crate_hash = "ab8cfca66ad784f9";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m thiserror-2_0_11-script_build-ab8cfca66ad784f9"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=d7ad892fe854bf3b \
        -C extra-filename=-ab8cfca66ad784f9 \
        --out-dir $OUT_DIR \
        ${fn.rustc_linker_arguments passthru.rust_crate_libraries} \
        ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
        --cap-lints allow
      ln -s $OUT_DIR/"$CARGO_CRATE_NAME"-ab8cfca66ad784f9 $OUT_DIR/build_script_build
      )
    '';
}
