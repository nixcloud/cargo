...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-pack-0_57_0-e8c0e5e82661a842";
    meta.cargo_crate_info = {
      name = "gix-pack";
      version = "0.57.0";
      crate_hash = "e8c0e5e82661a842";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [clru-0_6_2-c9b6442ce9e8d394 gix-chunk-0_4_11-70b4db6c26d17c10 gix-features-0_40_0-28fa590012f22da9 gix-hash-0_16_0-c47a8c0103fbbf5d gix-hashtable-0_7_0-f73f6779ef0c35fc gix-object-0_47_0-d62e7b541181e72a gix-path-0_10_14-2414f38f73019524 gix-tempfile-16_0_0-82af46aa830dfb66 memmap2-0_9_5-11f8a1a36d715298 parking_lot-0_12_3-ff08a1b844db7fce smallvec-1_13_2-453c588ad74a5894 thiserror-2_0_11-266d93aab4cee78a];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-pack-0_57_0-e8c0e5e82661a842"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=75e93c3f41bb880c \
        -C extra-filename=-e8c0e5e82661a842 \
        --out-dir $OUT_DIR \
        ${fn.rustc_linker_arguments passthru.rust_crate_libraries} \
        ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
        --extern clru=${clru-0_6_2-c9b6442ce9e8d394}/libclru-c9b6442ce9e8d394.rmeta \
