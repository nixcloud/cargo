...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "sha1_smol-1_0_1-94cb93bd3f292a02";
    meta.cargo_crate_info = {
      name = "sha1_smol";
      version = "1.0.1";
      crate_hash = "94cb93bd3f292a02";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m sha1_smol-1_0_1-94cb93bd3f292a02"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=ce990edbfe12f96f \
        -C extra-filename=-94cb93bd3f292a02 \
        --out-dir $OUT_DIR \
