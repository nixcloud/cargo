...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "autocfg-1_4_0-6353892153b58c07";
    meta.cargo_crate_info = {
      name = "autocfg";
      version = "1.4.0";
      crate_hash = "6353892153b58c07";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m autocfg-1_4_0-6353892153b58c07"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=93e0477ba11705f2 \
        -C extra-filename=-6353892153b58c07 \
        --out-dir $OUT_DIR \
