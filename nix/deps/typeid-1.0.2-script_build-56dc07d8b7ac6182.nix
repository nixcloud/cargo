...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "typeid-1_0_2-script_build-56dc07d8b7ac6182";
    meta.cargo_crate_info = {
      name = "typeid";
      version = "1.0.2";
      crate_hash = "56dc07d8b7ac6182";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m typeid-1_0_2-script_build-56dc07d8b7ac6182"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=ba7031e1cf775449 \
        -C extra-filename=-56dc07d8b7ac6182 \
        --out-dir $OUT_DIR \
        ${fn.rustc_linker_arguments passthru.rust_crate_libraries} \
        ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
        --cap-lints allow
      ln -s $OUT_DIR/"$CARGO_CRATE_NAME"-56dc07d8b7ac6182 $OUT_DIR/build_script_build
      )
    '';
}
