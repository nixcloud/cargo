...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-url-0_29_0-75b9f18fc4d5606d";
    meta.cargo_crate_info = {
      name = "gix-url";
      version = "0.29.0";
      crate_hash = "75b9f18fc4d5606d";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [bstr-1_11_3-29be561fe10b8eeb gix-features-0_40_0-28fa590012f22da9 gix-path-0_10_14-2414f38f73019524 percent-encoding-2_3_1-3c9d9c63ad89d268 thiserror-2_0_11-266d93aab4cee78a url-2_5_4-f84eb31ea66b0c06];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-url-0_29_0-75b9f18fc4d5606d"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=1d8d59eab7d97583 \
        -C extra-filename=-75b9f18fc4d5606d \
        --out-dir $OUT_DIR \
