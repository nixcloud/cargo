...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "winnow-0_7_1-5732cc07f2007cc7";
    meta.cargo_crate_info = {
      name = "winnow";
      version = "0.7.1";
      crate_hash = "5732cc07f2007cc7";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m winnow-0_7_1-5732cc07f2007cc7"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=9a80f09d3544787e \
        -C extra-filename=-5732cc07f2007cc7 \
        --out-dir $OUT_DIR \
