...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "libz-sys-1_1_21-dca0372fd8ac9ea4";
    meta.cargo_crate_info = {
      name = "libz-sys";
      version = "1.1.21";
      crate_hash = "dca0372fd8ac9ea4";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [libc-0_2_170-d46a143b0470970d];
    passthru.rust_crate_parent = [libz-sys-1_1_21-script_build_run-9964415cd6446950];
    passthru.rust_script_build_run = [libz-sys-1_1_21-script_build_run-9964415cd6446950];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m libz-sys-1_1_21-dca0372fd8ac9ea4"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=7d1196ec92856835 \
        -C extra-filename=-dca0372fd8ac9ea4 \
        --out-dir $OUT_DIR \
