...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "static_assertions-1_1_0-9ad90952c22c4102";
    meta.cargo_crate_info = {
      name = "static_assertions";
      version = "1.1.0";
      crate_hash = "9ad90952c22c4102";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m static_assertions-1_1_0-9ad90952c22c4102"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=5deb10662bb9b6b7 \
        -C extra-filename=-9ad90952c22c4102 \
        --out-dir $OUT_DIR \
