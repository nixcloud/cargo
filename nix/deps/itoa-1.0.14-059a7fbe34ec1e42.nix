...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "itoa-1_0_14-059a7fbe34ec1e42";
    meta.cargo_crate_info = {
      name = "itoa";
      version = "1.0.14";
      crate_hash = "059a7fbe34ec1e42";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m itoa-1_0_14-059a7fbe34ec1e42"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=76a542a5865d0251 \
        -C extra-filename=-059a7fbe34ec1e42 \
        --out-dir $OUT_DIR \
