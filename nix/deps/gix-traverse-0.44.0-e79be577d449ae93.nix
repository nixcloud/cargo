...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "gix-traverse-0_44_0-e79be577d449ae93";
    meta.cargo_crate_info = {
      name = "gix-traverse";
      version = "0.44.0";
      crate_hash = "e79be577d449ae93";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m gix-traverse-0_44_0-e79be577d449ae93"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=22f029f62b6d97fb \
        -C extra-filename=-e79be577d449ae93 \
        --out-dir $OUT_DIR \
