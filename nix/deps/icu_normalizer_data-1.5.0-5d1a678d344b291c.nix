...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "icu_normalizer_data-1_5_0-5d1a678d344b291c";
    meta.cargo_crate_info = {
      name = "icu_normalizer_data";
      version = "1.5.0";
      crate_hash = "5d1a678d344b291c";
    };
    ...
    src = pkgs.fetchurl {
      url = "https://crates.io/api/v1/crates/icu_normalizer_data/1.5.0/download";
      sha256 = "f8cafbf7aa791e9b22bec55a167906f9e1215fd475cd22adfcf660e03e989516";
    };
    unpackPhase = ''
      tar xf $src
      cd icu_normalizer_data-1.5.0
    '';
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m icu_normalizer_data-1_5_0-5d1a678d344b291c"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=1c8d8609c321fc69 \
        -C extra-filename=-5d1a678d344b291c \
        --out-dir $OUT_DIR \
