...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "anstyle-parse-0_2_6-4881a1eda670a37e";
    meta.cargo_crate_info = {
      name = "anstyle-parse";
      version = "0.2.6";
      crate_hash = "4881a1eda670a37e";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [utf8parse-0_2_2-ed0f948dddfa5152];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m anstyle-parse-0_2_6-4881a1eda670a37e"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=566274dd5edc7981 \
        -C extra-filename=-4881a1eda670a37e \
        --out-dir $OUT_DIR \
