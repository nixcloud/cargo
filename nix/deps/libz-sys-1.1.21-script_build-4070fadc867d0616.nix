...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "libz-sys-1_1_21-script_build-4070fadc867d0616";
    meta.cargo_crate_info = {
      name = "libz-sys";
      version = "1.1.21";
      crate_hash = "4070fadc867d0616";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m libz-sys-1_1_21-script_build-4070fadc867d0616"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=49b5b6216a35d648 \
        -C extra-filename=-4070fadc867d0616 \
        --out-dir $OUT_DIR \
        ...
        --cap-lints allow
      ln -s $OUT_DIR/"$CARGO_CRATE_NAME"-4070fadc867d0616 $OUT_DIR/build_script_build
      )
    '';
}
