...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "serde_spanned-0_6_8-c4b0fe3777090086";
    meta.cargo_crate_info = {
      name = "serde_spanned";
      version = "0.6.8";
      crate_hash = "c4b0fe3777090086";
    };
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m serde_spanned-0_6_8-c4b0fe3777090086"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=d7efa7f573d82cd1 \
        -C extra-filename=-c4b0fe3777090086 \
        --out-dir $OUT_DIR \
