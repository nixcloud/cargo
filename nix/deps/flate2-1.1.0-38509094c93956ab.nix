...
{ fn, pkgs, rustc, cargo, deps }: with deps;
  pkgs.stdenv.mkDerivation rec {
    name = "flate2-1_1_0-38509094c93956ab";
    meta.cargo_crate_info = {
      name = "flate2";
      version = "1.1.0";
      crate_hash = "38509094c93956ab";
    };
    buildInputs = [] ++ fn.inject meta.cargo_crate_info;
    passthru.rust_crate_libraries = [crc32fast-1_4_2-364c5844de60373e libz-sys-1_1_21-dca0372fd8ac9ea4 miniz_oxide-0_8_5-4e9fe3e767c62429];
...
";
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m flate2-1_1_0-38509094c93956ab"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=81a7763597f7f00f \
        -C extra-filename=-38509094c93956ab \
        --out-dir $OUT_DIR \
        ...
        --extern miniz_oxide=${miniz_oxide-0_8_5-4e9fe3e767c62429}/libminiz_oxide-4e9fe3e767c62429.rmeta \
        --cap-lints allow
      )
    '';
}
